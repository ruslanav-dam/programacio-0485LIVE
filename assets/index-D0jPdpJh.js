 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function r(O,B){var G=O.length;O.push(B);e:for(;0<G;){var ae=G-1>>>1,de=O[ae];if(0<i(de,B))O[ae]=B,O[G]=de,G=ae;else break e}}function a(O){return O.length===0?null:O[0]}function n(O){if(O.length===0)return null;var B=O[0],G=O.pop();if(G!==B){O[0]=G;e:for(var ae=0,de=O.length,ye=de>>>1;ae<ye;){var Le=2*(ae+1)-1,Fe=O[Le],Ee=Le+1,He=O[Ee];if(0>i(Fe,G))Ee<de&&0>i(He,Fe)?(O[ae]=He,O[Ee]=G,ae=Ee):(O[ae]=Fe,O[Le]=G,ae=Le);else if(Ee<de&&0>i(He,G))O[ae]=He,O[Ee]=G,ae=Ee;else break e}}return B}function i(O,B){var G=O.sortIndex-B.sortIndex;return G!==0?G:O.id-B.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var l=Date,o=l.now();t.unstable_now=function(){return l.now()-o}}var c=[],u=[],m=1,d=null,x=3,y=!1,v=!1,b=!1,E=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function j(O){for(var B=a(u);B!==null;){if(B.callback===null)n(u);else if(B.startTime<=O)n(u),B.sortIndex=B.expirationTime,r(c,B);else break;B=a(u)}}function R(O){if(b=!1,j(O),!v)if(a(c)!==null)v=!0,$(N);else{var B=a(u);B!==null&&re(R,B.startTime-O)}}function N(O,B){v=!1,b&&(b=!1,h(w),w=-1),y=!0;var G=x;try{for(j(B),d=a(c);d!==null&&(!(d.expirationTime>B)||O&&!le());){var ae=d.callback;if(typeof ae=="function"){d.callback=null,x=d.priorityLevel;var de=ae(d.expirationTime<=B);B=t.unstable_now(),typeof de=="function"?d.callback=de:d===a(c)&&n(c),j(B)}else n(c);d=a(c)}if(d!==null)var ye=!0;else{var Le=a(u);Le!==null&&re(R,Le.startTime-B),ye=!1}return ye}finally{d=null,x=G,y=!1}}var P=!1,_=null,w=-1,H=5,F=-1;function le(){return!(t.unstable_now()-F<H)}function ee(){if(_!==null){var O=t.unstable_now();F=O;var B=!0;try{B=_(!0,O)}finally{B?ve():(P=!1,_=null)}}else P=!1}var ve;if(typeof p=="function")ve=function(){p(ee)};else if(typeof MessageChannel<"u"){var te=new MessageChannel,q=te.port2;te.port1.onmessage=ee,ve=function(){q.postMessage(null)}}else ve=function(){E(ee,0)};function $(O){_=O,P||(P=!0,ve())}function re(O,B){w=E(function(){O(t.unstable_now())},B)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(O){O.callback=null},t.unstable_continueExecution=function(){v||y||(v=!0,$(N))},t.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):H=0<O?Math.floor(1e3/O):5},t.unstable_getCurrentPriorityLevel=function(){return x},t.unstable_getFirstCallbackNode=function(){return a(c)},t.unstable_next=function(O){switch(x){case 1:case 2:case 3:var B=3;break;default:B=x}var G=x;x=B;try{return O()}finally{x=G}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(O,B){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var G=x;x=O;try{return B()}finally{x=G}},t.unstable_scheduleCallback=function(O,B,G){var ae=t.unstable_now();switch(typeof G=="object"&&G!==null?(G=G.delay,G=typeof G=="number"&&0<G?ae+G:ae):G=ae,O){case 1:var de=-1;break;case 2:de=250;break;case 5:de=1073741823;break;case 4:de=1e4;break;default:de=5e3}return de=G+de,O={id:m++,callback:B,priorityLevel:O,startTime:G,expirationTime:de,sortIndex:-1},G>ae?(O.sortIndex=G,r(u,O),a(c)===null&&O===a(u)&&(b?(h(w),w=-1):b=!0,re(R,G-ae))):(O.sortIndex=de,r(c,O),v||y||(v=!0,$(N))),O},t.unstable_shouldYield=le,t.unstable_wrapCallback=function(O){var B=x;return function(){var G=x;x=B;try{return O.apply(this,arguments)}finally{x=G}}}})(Gd);Ud.exports=Gd;var yf=Ud.exports;/**
 * @license React
