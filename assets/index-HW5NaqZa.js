...
int d = 2;`}),e.jsxs(me,{children:[e.jsxs(T,{title:"AND (&&)",variant:"blue",children:[e.jsxs("p",{children:["Retorna TRUE únicament quan ",e.jsx("strong",{children:"AMBDUES"})," expressions/valors són TRUE"]}),e.jsxs("ul",{style:{marginTop:"10px",paddingLeft:"20px",listStyle:"none"},children:[e.jsx("li",{children:"(a && b) → com ambdues són true, el resultat és true."}),e.jsx("li",{children:"(a && b) && (c == d) → com ambdues expressions són true, aleshores (true && true) → true."}),e.jsx("li",{children:"(a && b) && (c > d) → com l'expressió de la dreta és false, aleshores (true && false) → false."})]})]}),e.jsxs(T,{title:"OR (||)",variant:"yellow",children:[e.jsxs("p",{children:["Al contrari que el AND, retorna TRUE si ",e.jsx("strong",{children:"AL MENYS UNA"})," expressió té valor TRUE"]}),e.jsxs("ul",{style:{marginTop:"10px",paddingLeft:"20px",listStyle:"none"},children:[e.jsx("li",{children:"(a || b) → com almenys una és true, el resultat és true."}),e.jsx("li",{children:"(a || false) → com a és true, el resultat és true."}),e.jsx("li",{children:"(false || false) → com cap és true, el resultat és false."}),e.jsx("li",{children:"(c == d || c > d) → (true || false) → true."})]})]}),e.jsx(T,{title:"NOT (!)",variant:"pink",children:e.jsx("p",{children:"Inverteix el valor d'una expressió booleana."})})]})]})}function PS(){return e.jsxs("div",{children:[e.jsx(S,{title:"Sintaxi de Java"}),e.jsx(h,{variant:"info",children:e.jsx("p",{children:"La sintaxi de Java és estructurada i orientada a objectes, heretada en gran part de C++. A continuació estan les estructures fonamentals del llenguatge: condicionals i bucles i, juntament amb la seva respectiva sintaxi per escriure codi clar i organitzat."})}),e.jsx(J,{headers:["Nom","Paraula reservada","Sintaxi"],rows:[{cells:["Variable","tipus","tipus variable = valor"]},{cells:["Constant","final","final tipus constant = valor"]},{cells:["Condicional if","if","if (condició) { }"]},{cells:["Condicional else if","else if","else if (altra_condició) { }"]},{cells:["Condicional else","else","else { }"]},{cells:["Bucle for","for","for (inicialització; condició; increment) { }"]},{cells:["Bucle for each","for","for (element : col·lecció) { }"]},{cells:["Bucle while","while","while (condició) { }"]},{cells:["Bucle do while","do while","do { } while (condició)"]},{cells:["Switch","switch","switch (variable) { case valor: }"]},{cells:["Mètode principal","main","public static void main (String[] args) { }"]},{cells:["Sentència break","break","break"]},{cells:["Sentència continue","continue","continue"]},{cells:["Retorn","return","return valor"]}]}),e.jsx(h,{variant:"explanation",title:"Extra",children:e.jsx("p",{children:"Un programa no és més que una seqüència d'instruccions que s'executen en ordre de dalt cap avall, llevat que utilitzem estructures que canvien aquest flux."})})]})}function NS(){return e.jsxs("div",{children:[e.jsx(S,{title:'Estructures condicionals → "fer preguntes"'}),e.jsx(h,{variant:"info",children:e.jsx("p",{children:"Utilitzem una estructura condicional quan el programa ha de prendre decisions."})}),e.jsxs(T,{title:"Exemple vida real",variant:"blue",children:[e.jsx("p",{children:"Si plou,"}),e.jsx("p",{children:"porto paraigua."}),e.jsx("p",{children:"Si no,"}),e.jsx("p",{children:"no me'l porto."})]}),e.jsxs(T,{title:"Esquema mental",variant:"yellow",children:[e.jsx("p",{children:"SI (condició és verdadera) → faig alguna cosa"}),e.jsx("p",{children:"SI NO → faig una altra cosa"})]}),e.jsx(g,{label:"En codi",code:`if (plou) {
    ...
    noPortoParagua();
}`})]})}function kS(){return e.jsxs("div",{children:[e.jsx(S,{title:`Switch → "menú d'opcions"`}),e.jsx(h,{variant:"info",children:e.jsx("p",{children:"Utilitzem switch quan tenim diverses opcions possibles i només una pot ser la correcta."})}),e.jsxs(T,{title:"Exemple vida real",variant:"blue",children:[e.jsx("p",{children:"Entro a un restaurant i trio:"}),e.jsx("p",{children:"1 → Pizza"}),e.jsx("p",{children:"2 → Amanida"}),e.jsx("p",{children:"3 → Pasta"})]}),e.jsx(T,{title:"Esquema mental",variant:"yellow",children:e.jsx("p",{children:"SEGONS l'opció que triïs → executo una cosa o una altra"})}),e.jsx(g,{label:"En codi",code:`switch (opcio) {
    case 1:
        demanarPizza();
        break;
    case 2:
...
}`;function g0(){return e.jsxs("div",{children:[e.jsx(S,{title:"Arrays Bidimensionals (Matrius)"}),e.jsx(h,{variant:"info",title:"Què és una Matriu?",children:e.jsxs("p",{children:["Una ",e.jsx("strong",{children:"matriu"})," (o array 2D) és un array d'arrays. Es pot pensar com una taula amb ",e.jsx("strong",{children:"files"})," i ",e.jsx("strong",{children:"columnes"}),". Cada element s'identifica amb dos índexos: ",e.jsx("code",{children:"[fila][columna]"}),"."]})}),e.jsx(d0,{}),e.jsx(h,{variant:"explanation",title:"Estructura d'una Matriu",children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Files:"})," cada fila és un array independent."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Columnes:"})," cada posició dins d'una fila."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Accés:"})," ",e.jsx("code",{children:"matriu[fila][columna]"})," per llegir o escriure."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Mida:"})," ",e.jsx("code",{children:"matriu.length"})," dona el nombre de files, ",e.jsx("code",{children:"matriu[0].length"})," dona les columnes."]})]})}),e.jsx(g,{code:p0,label:"Declaració de matrius",showLineNumbers:!0}),e.jsx(J,{headers:["Operació","Sintaxi","Descripció"],rows:[{cells:["Declarar buida","tipus[][] nom = new tipus[files][cols]","Crea matriu amb zeros"]},{cells:["Declarar amb valors","tipus[][] nom = {{...}, {...}}","Inicialitza amb valors"]},{cells:["Accedir element","nom[fila][col]","Llegeix un valor concret"]},{cells:["Nombre files","nom.length","Retorna total de files"]},{cells:["Nombre columnes","nom[0].length","Retorna columnes de la fila 0"]}]}),e.jsx(g,{code:m0,label:"Accés i modificació d'elements",showLineNumbers:!0}),e.jsx(g,{code:h0,label:"Recorregut complet de la matriu",showLineNumbers:!0}),e.jsx(h,{variant:"success",title:"Diagonal principal",children:e.jsxs("p",{children:["En una matriu quadrada (NxN), la ",e.jsx("strong",{children:"diagonal principal"})," són els elements on l'índex de fila és igual a l'índex de columna: ",e.jsx("code",{children:"matriu[i][i]"}),"."]})}),e.jsx(g,{code:f0,label:"Recórrer la diagonal",showLineNumbers:!0}),e.jsx(h,{variant:"info",title:"Exemple pràctic: Notes d'alumnes",children:e.jsx("p",{children:"Un cas d'ús habitual és guardar les notes de diversos alumnes en diverses assignatures, on cada fila representa un alumne i cada columna una assignatura."})}),e.jsx(g,{code:x0,label:"Exemple: Mitjana per alumne",showLineNumbers:!0})]})}const j0="_container_1elsv_1",v0="_title_1elsv_9",b0="_subtitle_1elsv_17",y0="_listArea_1elsv_25",S0="_listContainer_1elsv_33",E0="_emptyMessage_1elsv_41",C0="_cell_1elsv_48",w0="_cellValue_1elsv_55",A0="_cellHighlight_1elsv_79",L0="_cellShifting_1elsv_86",R0="_cellIndex_1elsv_92",M0="_controlsGrid_1elsv_101",T0="_controlGroup_1elsv_108",P0="_controlLabel_1elsv_115",N0="_controlRow_1elsv_124",k0="_console_1elsv_156",_0="_consoleLine_1elsv_170",q0="_consoleCode_1elsv_174",O0="_consoleResult_1elsv_178",I0="_consoleError_1elsv_182",D0="_consolePlaceholder_1elsv_186",F0="_sizeBar_1elsv_192",z0="_sizeBarLabel_1elsv_205",B0="_sizeBarTrack_1elsv_210",U0="_sizeBarFill_1elsv_218",fe={container:j0,title:v0,subtitle:b0,listArea:y0,listContainer:S0,emptyMessage:E0,cell:C0,cellValue:w0,cellHighlight:A0,cellShifting:L0,cellIndex:R0,controlsGrid:M0,controlGroup:T0,controlLabel:P0,controlRow:N0,console:k0,consoleLine:_0,consoleCode:q0,consoleResult:O0,consoleError:I0,consolePlaceholder:D0,sizeBar:F0,sizeBarLabel:z0,sizeBarTrack:B0,sizeBarFill:U0},Ei=15;function G0(){const[t,a]=A.useState(["Hola","Món","Java"]),[r,n]=A.useState([]),[i,s]=A.useState(null),[l,o]=A.useState([]),c=A.useRef(null),u=A.useRef(null),m=A.useRef(null),d=A.useRef(null),x=A.useRef(null),y=A.useRef(null),j=A.useRef(null),b=A.useRef(null),E=A.useRef(null);A.useEffect(()=>{E.current&&(E.current.scrollTop=E.current.scrollHeight)},[r]);const f=A.useCallback((q,H,ae=!1)=>{n(O=>[...O.slice(-25),{code:q,result:H,isError:ae,id:Date.now()+Math.random()}])},[]),p=A.useCallback(q=>{s(q),setTimeout(()=>s(null),800)},[]),v=A.useCallback(q=>{o(q),setTimeout(()=>o([]),600)},[]),R=()=>{var H;const q=(H=c.current)==null?void 0:H.value.trim();if(q){if(t.length>=Ei){f(`llista.add("${q}")`,`Error: massa elements (max ${Ei} per la demo)`,!0);return}a(ae=>[...ae,q]),f(`llista.add("${q}")`,`// S'afegeix "${q}" al final → mida = ${t.length+1}`),p(t.length),c.current.value="",c.current.focus()}},P=()=>{var O,B;const q=parseInt((O=u.current)==null?void 0:O.value),H=(B=m.current)==null?void 0:B.value.trim();if(isNaN(q)||!H)return;if(q<0||q>t.length){f(`llista.add(${q}, "${H}")`,`IndexOutOfBoundsException: Index ${q} fora de rang [0..${t.length}]`,!0);return}if(t.length>=Ei){f(`llista.add(${q}, "${H}")`,`Error: massa elements (max ${Ei})`,!0);return}const ae=[];for(let G=q;G<t.length;G++)ae.push(G+1);a(G=>[...G.slice(0,q),H,...G.slice(q)]),f(`llista.add(${q}, "${H}")`,`// Insereix "${H}" a posició ${q} → els elements es desplacen`),p(q),v(ae),u.current.value="",m.current.value=""},k=()=>{var O;const q=parseInt((O=d.current)==null?void 0:O.value);if(isNaN(q))return;if(q<0||q>=t.length){f(`llista.remove(${q})`,`IndexOutOfBoundsException: Index ${q} fora de rang [0..${t.length-1}]`,!0);return}const H=t[q],ae=[];for(let B=q+1;B<t.length;B++)ae.push(B-1);a(B=>B.filter((G,re)=>re!==q)),f(`llista.remove(${q})`,`// Elimina "${H}" de posició ${q} → retorna "${H}"`),v(ae),d.current.value=""},_=()=>{var H;const q=parseInt((H=x.current)==null?void 0:H.value);if(!isNaN(q)){if(q<0||q>=t.length){f(`llista.get(${q})`,`IndexOutOfBoundsException: Index ${q} fora de rang [0..${t.length-1}]`,!0);return}f(`llista.get(${q})`,`→ "${t[q]}"`),p(q),x.current.value=""}},w=()=>{var O,B;const q=parseInt((O=y.current)==null?void 0:O.value),H=(B=j.current)==null?void 0:B.value.trim();if(isNaN(q)||!H)return;if(q<0||q>=t.length){f(`llista.set(${q}, "${H}")`,`IndexOutOfBoundsException: Index ${q} fora de rang [0..${t.length-1}]`,!0);return}const ae=t[q];a(G=>G.map((re,de)=>de===q?H:re)),f(`llista.set(${q}, "${H}")`,`// Substitueix "${ae}" per "${H}" → retorna "${ae}"`),p(q),y.current.value="",j.current.value=""},$=()=>{var O;const q=(O=b.current)==null?void 0:O.value.trim();if(!q)return;const H=t.includes(q),ae=t.indexOf(q);f(`llista.contains("${q}")`,`→ ${H}${H?` (trobat a posició ${ae})`:""}`),H&&p(ae),b.current.value=""},F=()=>{f("llista.size()",`→ ${t.length}`)},le=()=>{a([]),f("llista.clear()","// S'han eliminat tots els elements → mida = 0")},ee=()=>{a(["Hola","Món","Java"]),n([]),s(null),o([])},je=q=>H=>{H.key==="Enter"&&q()},te=Math.max(10,Math.pow(2,Math.ceil(Math.log2(t.length||1)+.1)));return e.jsxs("div",{className:fe.container,children:[e.jsx("div",{className:fe.title,children:"Simulador Interactiu d'ArrayList"}),e.jsx("div",{className:fe.subtitle,children:"ArrayList<String> llista — Prova les operacions i observa el resultat!"}),e.jsx("div",{className:fe.listArea,children:t.length===0?e.jsx("div",{className:fe.emptyMessage,children:"[ ArrayList buit — afegeix elements! ]"}):e.jsx("div",{className:fe.listContainer,children:t.map((q,H)=>e.jsxs("div",{className:`${fe.cell} ${i===H?fe.cellHighlight:""} ${l.includes(H)?fe.cellShifting:""}`,children:[e.jsx("div",{className:fe.cellValue,children:`"${q}"`}),e.jsxs("div",{className:fe.cellIndex,children:["[",H,"]"]})]},`${H}-${q}-${t.length}`))})}),e.jsxs("div",{className:fe.sizeBar,children:[e.jsxs("span",{className:fe.sizeBarLabel,children:["size() = ",t.length]}),e.jsx("div",{className:fe.sizeBarTrack,children:e.jsx("div",{className:fe.sizeBarFill,style:{width:`${t.length/te*100}%`}})}),e.jsxs("span",{children:["capacitat interna ≈ ",te]})]}),e.jsxs("div",{className:fe.controlsGrid,children:[e.jsxs("div",{className:fe.controlGroup,children:[e.jsx("div",{className:fe.controlLabel,children:"Afegir elements"}),e.jsxs("div",{className:fe.controlRow,children:[e.jsx("input",{ref:c,placeholder:"valor",onKeyDown:je(R)}),e.jsx(it,{onClick:R,variant:"secondary",children:"add()"})]}),e.jsxs("div",{className:fe.controlRow,style:{marginTop:6},children:[e.jsx("input",{ref:u,placeholder:"pos",style:{maxWidth:50}}),e.jsx("input",{ref:m,placeholder:"valor",onKeyDown:je(P)}),e.jsx(it,{onClick:P,variant:"secondary",children:"add(i, v)"})]})]}),e.jsxs("div",{className:fe.controlGroup,children:[e.jsx("div",{className:fe.controlLabel,children:"Accedir i modificar"}),e.jsxs("div",{className:fe.controlRow,children:[e.jsx("input",{ref:x,placeholder:"pos",style:{maxWidth:50},onKeyDown:je(_)}),e.jsx(it,{onClick:_,variant:"secondary",children:"get(i)"}),e.jsx("input",{ref:d,placeholder:"pos",style:{maxWidth:50},onKeyDown:je(k)}),e.jsx(it,{onClick:k,variant:"secondary",children:"remove(i)"})]}),e.jsxs("div",{className:fe.controlRow,style:{marginTop:6},children:[e.jsx("input",{ref:y,placeholder:"pos",style:{maxWidth:50}}),e.jsx("input",{ref:j,placeholder:"nou valor",onKeyDown:je(w)}),e.jsx(it,{onClick:w,variant:"secondary",children:"set(i, v)"})]})]}),e.jsxs("div",{className:fe.controlGroup,children:[e.jsx("div",{className:fe.controlLabel,children:"Cercar i utilitats"}),e.jsxs("div",{className:fe.controlRow,children:[e.jsx("input",{ref:b,placeholder:"valor",onKeyDown:je($)}),e.jsx(it,{onClick:$,variant:"secondary",children:"contains()"})]}),e.jsxs("div",{className:fe.controlRow,style:{marginTop:6},children:[e.jsx(it,{onClick:F,variant:"secondary",children:"size()"}),e.jsx(it,{onClick:le,variant:"secondary",children:"clear()"}),e.jsx(it,{onClick:ee,children:"Reset"})]})]})]}),e.jsx("div",{className:fe.console,ref:E,children:r.length===0?e.jsx("div",{className:fe.consolePlaceholder,children:"// Fes clic als botons per veure el codi Java equivalent..."}):r.map(q=>e.jsxs("div",{className:fe.consoleLine,children:[e.jsx("span",{className:fe.consoleCode,children:q.code})," ",e.jsx("span",{className:q.isError?fe.consoleError:fe.consoleResult,children:q.result})]},q.id))})]})}const H0="import java.util.ArrayList;",$0=`// Crear un ArrayList de Strings
...
}`;function S1(){return e.jsxs("div",{children:[e.jsx(S,{title:"Funcions amb Paràmetres"}),e.jsx(h,{variant:"info",title:"Paràmetres i Arguments",children:e.jsxs("p",{children:["Les funcions amb ",e.jsx("strong",{children:"paràmetres"})," reben dades d'entrada que poden utilitzar dins del seu cos. Els ",e.jsx("strong",{children:"paràmetres"})," es defineixen a la declaració de la funció, i els ",e.jsx("strong",{children:"arguments"})," són els valors concrets que es passen quan es crida la funció."]})}),e.jsx(Th,{mode:"with-params"}),e.jsx(g,{code:v1,label:"Estructura d'una funció amb paràmetres",showLineNumbers:!0}),e.jsx(J,{headers:["Concepte","Descripció","Exemple"],rows:[{cells:["Paràmetre","Variable declarada a la signatura","(int a, int b)"]},{cells:["Argument","Valor passat en la crida","sumar(5, 3)"]},{cells:["Pas per valor","Java copia el valor del primitiu","int, double, char..."]},{cells:["Pas per referència","Java copia la referència de l'objecte","String, arrays, objectes"]}]}),e.jsx(h,{variant:"explanation",title:"Diferència entre Paràmetre i Argument",children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Paràmetre:"}),' és la variable a la definició de la funció. És com un "espai reservat".']}),e.jsxs("li",{children:[e.jsx("strong",{children:"Argument:"})," és el valor real que enviem quan cridem la funció."]}),e.jsxs("li",{children:["Exemple: en ",e.jsx("code",{children:"static int sumar(int a, int b)"}),", ",e.jsx("code",{children:"a"})," i ",e.jsx("code",{children:"b"})," són paràmetres."]}),e.jsxs("li",{children:["Quan cridem ",e.jsx("code",{children:"sumar(5, 3)"}),", ",e.jsx("code",{children:"5"})," i ",e.jsx("code",{children:"3"})," són arguments."]})]})}),e.jsx(g,{code:b1,label:"Exemples bàsics de funcions amb paràmetres",showLineNumbers:!0}),e.jsx(h,{variant:"warning",title:"Ordre i tipus dels arguments",children:e.jsxs("p",{children:["Quan cridem una funció, els arguments han de coincidir en ",e.jsx("strong",{children:"nombre"}),",",e.jsx("strong",{children:" ordre"})," i ",e.jsx("strong",{children:"tipus"})," amb els paràmetres declarats. Si no, Java donarà un error de compilació."]})}),e.jsx(g,{code:y1,label:"Funcions amb múltiples paràmetres",showLineNumbers:!0})]})}const E1=`public class Exemples {
...
}`;function rE(){return e.jsxs("div",{children:[e.jsx(S,{title:"Funcions Recursives"}),e.jsx(h,{variant:"info",title:"Què és la Recursivitat?",children:e.jsxs("p",{children:["La ",e.jsx("strong",{children:"recursivitat"})," és una tècnica on una funció es crida a si mateixa per resoldre un problema. Cada crida resol una part més petita del problema fins arribar a un ",e.jsx("strong",{children:"cas base"})," que atura la recursió."]})}),e.jsx(X1,{}),e.jsx(h,{variant:"explanation",title:"Els dos elements clau",children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Cas base:"})," la condició que atura la recursió. Sense cas base, la funció es cridaria infinitament i provocaria un ",e.jsx("code",{children:"StackOverflowError"}),"."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Cas recursiu:"})," la funció es crida a si mateixa amb paràmetres més simples o més petits, acostant-se al cas base."]})]})}),e.jsx(g,{code:Z1,label:"Estructura d'una funció recursiva",showLineNumbers:!0}),e.jsx(J,{headers:["Concepte","Descripció","Importància"],rows:[{cells:["Cas base","Condició de parada de la recursió","Obligatori per evitar bucle infinit"]},{cells:["Cas recursiu","La funció es crida amb dades més simples","Ha de convergir cap al cas base"]},{cells:["Pila de crides","Cada crida s'apila fins al cas base","Limitat per la memòria de la pila"]},{cells:["StackOverflowError","Error si no hi ha cas base o no convergeix","Cal evitar-lo sempre"]}]}),e.jsx(h,{variant:"success",title:"Factorial (n!)",children:e.jsxs("p",{children:["El factorial és l'exemple clàssic de recursivitat: ",e.jsx("code",{children:"n! = n * (n-1)!"})," amb cas base ",e.jsx("code",{children:"0! = 1"}),"."]})}),e.jsx(g,{code:eE,label:"Exemple: Factorial recursiu",showLineNumbers:!0}),e.jsx(h,{variant:"success",title:"Fibonacci",children:e.jsxs("p",{children:["La seqüència de Fibonacci es defineix com: ",e.jsx("code",{children:"fib(n) = fib(n-1) + fib(n-2)"}),", amb casos base ",e.jsx("code",{children:"fib(0) = 0"})," i ",e.jsx("code",{children:"fib(1) = 1"}),"."]})}),e.jsx(g,{code:tE,label:"Exemple: Fibonacci recursiu",showLineNumbers:!0}),e.jsx(h,{variant:"warning",title:"Eficiència de la recursió",children:e.jsxs("p",{children:["La versió recursiva de Fibonacci és molt ineficient perquè recalcula els mateixos valors moltes vegades. Per a valors grans de ",e.jsx("code",{children:"n"}),", és preferible utilitzar un enfocament iteratiu o ",e.jsx("strong",{children:"memoització"}),"."]})}),e.jsx(g,{code:aE,label:"Més exemples: Suma i Potència recursius",showLineNumbers:!0})]})}const nE=`public class Calculadora {
...
}`;function lE(){return e.jsxs("div",{children:[e.jsx(S,{title:"Cridar Funcions des del Main"}),e.jsx(h,{variant:"info",title:"El mètode main()",children:e.jsxs("p",{children:["El mètode ",e.jsx("code",{children:"public static void main(String[] args)"})," és el"," ",e.jsx("strong",{children:"punt d'entrada"})," de qualsevol programa Java. Des d'aquí cridem les nostres funcions per executar la lògica del programa. Les funcions han de ser"," ",e.jsx("code",{children:"static"})," per poder-les cridar des del ",e.jsx("code",{children:"main"})," sense crear objectes."]})}),e.jsx(h,{variant:"explanation",title:"Flux d'execució",children:e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"1."})," El programa comença sempre al ",e.jsx("code",{children:"main()"}),"."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"2."}),` Quan es crida una funció, l'execució "salta" al cos de la funció.`]}),e.jsxs("li",{children:[e.jsx("strong",{children:"3."})," Un cop la funció acaba (amb ",e.jsx("code",{children:"return"})," o al final del bloc), l'execució torna al punt on es va cridar."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"4."})," El valor retornat es pot guardar en una variable o usar directament."]})]})}),e.jsx(h,{variant:"success",title:"Exemple 1: Calculadora",children:e.jsxs("p",{children:["Combina funcions sense paràmetres (menú) i amb paràmetres (operacions). El ",e.jsx("code",{children:"main"})," coordina el flux."]})}),e.jsx(g,{code:nE,label:"Exemple 1: Calculadora amb funcions",showLineNumbers:!0}),e.jsx(h,{variant:"success",title:"Exemple 2: Gestor de Notes",children:e.jsx("p",{children:"Mostra com encadenar crides a funcions: el resultat d'una funció es passa com a argument de la següent. Cada funció fa una tasca concreta."})}),e.jsx(g,{code:iE,label:"Exemple 2: Crides encadenades de funcions",showLineNumbers:!0}),e.jsx(h,{variant:"warning",title:"Bones pràctiques",children:e.jsxs("ul",{children:[e.jsxs("li",{children:["Cada funció ha de fer ",e.jsx("strong",{children:"una sola cosa"})," i fer-la bé."]}),e.jsxs("li",{children:["Dona noms ",e.jsx("strong",{children:"descriptius"})," a les funcions (verbs: calcular, obtenir, mostrar...)."]}),e.jsxs("li",{children:["El ",e.jsx("code",{children:"main"})," ha de ser ",e.jsx("strong",{children:"curt i clar"}),": coordina, no calcula."]}),e.jsx("li",{children:"Reutilitza funcions en lloc de copiar codi."})]})}),e.jsx(h,{variant:"success",title:"Exemple 3: Joc d'endevinar",children:e.jsx("p",{children:"Un exemple més complet que combina funcions sense paràmetres, amb paràmetres i recursivitat per crear un petit joc interactiu."})}),e.jsx(g,{code:sE,label:"Exemple 3: Combinant tots els tipus de funcions",showLineNumbers:!0})]})}const oE=`public class ResumComplet {
    // Array 1D
...
aulaJava.impartirClasse();`}),e.jsx(S,{title:"Els 4 Pilars de la POO"}),e.jsx(h,{variant:"explanation",children:e.jsxs("p",{children:["La POO es fonamenta en ",e.jsx("strong",{children:"4 pilars"})," fonamentals que fan que el codi sigui organitzat, segur, reutilitzable i flexible."]})}),e.jsxs(me,{children:[e.jsxs(T,{title:"Encapsulació",variant:"blue",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Amagar les dades internes"})," d'un objecte i controlar-ne l'accés mitjançant mètodes públics (getters i setters)."]}),e.jsx("p",{style:{marginTop:"8px"},children:"Com una càpsula de medicament: no veus el contingut, però funciona."}),e.jsx(g,{code:`private String nom;
...
p.nom = "";   // Nom buit acceptat!`}),e.jsx(h,{variant:"error",children:e.jsx("p",{children:"No hi ha cap validació. Es poden assignar valors incorrectes."})})]}),e.jsxs(U,{title:"BÉ: Amb encapsulació",variant:"good",children:[e.jsx("p",{children:"Atributs privats amb getters/setters que validen les dades."}),e.jsx(g,{showLineNumbers:!0,code:`public class Persona {
    private String nom;
    private int edat;
...
}`}),e.jsx(h,{variant:"success",children:e.jsx("p",{children:"Les dades estan protegides i validades."})})]})]}),e.jsx(S,{title:"Getters i Setters"}),e.jsx(h,{variant:"info",children:e.jsxs("p",{children:["Els ",e.jsx("strong",{children:"getters"})," són mètodes que retornen el valor d'un atribut privat. Els ",e.jsx("strong",{children:"setters"})," són mètodes que permeten modificar el valor d'un atribut privat, habitualment amb validació."]})}),e.jsx(g,{label:"Exemple complet amb getters i setters",showLineNumbers:!0,code:`public class Alumne {
...
}`}),e.jsx(h,{variant:"explanation",children:e.jsxs("p",{children:["Fixa't que el constructor ",e.jsx("strong",{children:"no té"})," ",e.jsx("code",{children:"void"})," ni cap altre tipus de retorn. Si hi poses ",e.jsx("code",{children:"void"}),", Java ho tractarà com un mètode normal, no com un constructor!"]})}),e.jsx(S,{title:"La Paraula Clau this"}),e.jsx(h,{variant:"info",children:e.jsxs("p",{children:["La paraula clau ",e.jsx("code",{children:"this"})," fa referència a l'",e.jsx("strong",{children:"objecte actual"}),". S'utilitza principalment quan el nom del paràmetre del constructor (o mètode) coincideix amb el nom de l'atribut de la classe."]})}),e.jsxs(oe,{children:[e.jsxs(U,{title:"Sense this (problema)",variant:"bad",children:[e.jsx(g,{code:`public Cotxe(String marca) {
    marca = marca; // ERROR!
    // Assigna el parametre a si mateix
    // L'atribut NO es modifica
}`}),e.jsx(h,{variant:"error",children:e.jsx("p",{children:"Java no sap distingir entre l'atribut i el paràmetre. L'atribut queda sense valor."})})]}),e.jsxs(U,{title:"Amb this (correcte)",variant:"good",children:[e.jsx(g,{code:`public Cotxe(String marca) {
    this.marca = marca; // CORRECTE!
    // this.marca = atribut de la classe
    // marca = parametre del constructor
}`}),e.jsx(h,{variant:"success",children:e.jsxs("p",{children:[e.jsx("code",{children:"this.marca"})," es refereix a l'atribut de l'objecte. ",e.jsx("code",{children:"marca"})," és el paràmetre."]})})]})]}),e.jsx(S,{title:"Exemple Complet"}),e.jsx(g,{label:"Classe Cotxe amb constructor",showLineNumbers:!0,code:`public class Cotxe {
...
a.ferSoroll();  // "Bup bup!" (no "Soroll generic")`;function IE(){return e.jsxs("div",{children:[e.jsx(S,{title:"Polimorfisme en Java"}),e.jsx(h,{variant:"info",title:"Què és el polimorfisme?",children:e.jsxs("p",{children:[e.jsx("strong",{children:"Polimorfisme"})," ve del grec: ",e.jsx("em",{children:"poli"})," (molts) + ",e.jsx("em",{children:"morphe"})," (forma). Significa que ",e.jsx("strong",{children:"un mateix mètode pot comportar-se de manera diferent"})," segons l'objecte que l'executa. És el tercer pilar de la POO, juntament amb l'encapsulació i l'herència."]})}),e.jsxs(h,{variant:"explanation",title:"Analogia del món real",children:[e.jsxs("p",{children:["Pensa en el botó ",e.jsx("strong",{children:'"Play"'})," del mòbil. El mateix botó fa coses diferents segons el context: a Spotify reprodueix música, a YouTube reprodueix un vídeo, a un podcast reprodueix àudio. El botó és el ",e.jsx("strong",{children:"mateix"})," (mateixa interfície), però el ",e.jsx("strong",{children:"comportament canvia"})," segons l'aplicació (l'objecte real)."]}),e.jsxs("p",{style:{marginTop:"8px"},children:["En Java passa igual: pots cridar ",e.jsx("code",{children:"ferSoroll()"})," sobre qualsevol ",e.jsx("code",{children:"Animal"}),", i cada animal farà el ",e.jsx("strong",{children:"seu propi soroll"}),"."]})]}),e.jsx(S,{title:"El Problema sense Polimorfisme"}),e.jsx(h,{variant:"warning",title:"Sense polimorfisme: codi repetitiu i rígid",children:e.jsxs("p",{children:["Imagina que tenim les classes ",e.jsx("code",{children:"Gos"}),", ",e.jsx("code",{children:"Gat"})," i ",e.jsx("code",{children:"Ocell"})," que ja coneixem de l'herència. Sense polimorfisme, cada vegada que volem fer una acció amb diferents tipus d'animals, necessitem un mètode específic per a ",e.jsx("strong",{children:"cada tipus"}),":"]})}),e.jsx(g,{label:"Sense polimorfisme: un mètode per cada tipus",code:CE,showLineNumbers:!0}),e.jsx(h,{variant:"error",title:"Problemes d'aquest enfocament",children:e.jsxs("ul",{style:{paddingLeft:"20px",marginTop:"8px"},children:[e.jsxs("li",{children:["Si afegim un nou animal (Serp, Peix...), hem d'afegir un ",e.jsx("strong",{children:"nou mètode"})," cada vegada."]}),e.jsxs("li",{children:["Si tenim 20 tipus d'animals, necessitem ",e.jsx("strong",{children:"20 mètodes"})," gairebé iguals."]}),e.jsxs("li",{children:["El codi és ",e.jsx("strong",{children:"repetitiu, fràgil i difícil de mantenir"}),"."]})]})}),e.jsx(S,{title:"La Solució: Polimorfisme"}),e.jsx(h,{variant:"info",children:e.jsxs("p",{children:["Recordem les classes d'herència. Cada animal sobreescriu (",e.jsx("code",{children:"@Override"}),") el mètode ",e.jsx("code",{children:"ferSoroll()"}),":"]})}),e.jsx(g,{label:"Classes amb herència i @Override (ja les coneixem!)",code:AE,showLineNumbers:!0}),e.jsx(h,{variant:"success",title:"Ara ve la màgia del polimorfisme",children:e.jsxs("p",{children:["La clau: podem guardar un objecte ",e.jsx("code",{children:"Gos"})," dins d'una variable de tipus ",e.jsx("code",{children:"Animal"}),". Quan cridem ",e.jsx("code",{children:"ferSoroll()"}),", Java executarà el mètode del ",e.jsx("strong",{children:"Gos"}),", no el de l'Animal genèric."]})}),e.jsx(g,{label:"Amb polimorfisme: UN mètode per a TOTS",code:wE,showLineNumbers:!0}),e.jsx(h,{variant:"success",title:"Què ha canviat?",children:e.jsxs("ul",{style:{paddingLeft:"20px",marginTop:"8px"},children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Un sol mètode"})," ",e.jsx("code",{children:"ferSoroll(Animal a)"})," serveix per a TOTS els animals."]}),e.jsxs("li",{children:["Si afegim un nou animal (",e.jsx("code",{children:"Serp"}),"), ",e.jsx("strong",{children:"no cal tocar"})," el mètode."]}),e.jsxs("li",{children:["Java decideix ",e.jsx("strong",{children:"automàticament"})," quin ",e.jsx("code",{children:"ferSoroll()"})," cridar segons l'objecte real."]})]})}),e.jsx(S,{title:"Tipus Estàtic vs Tipus Dinàmic"}),e.jsx(h,{variant:"explanation",title:"El concepte més important del polimorfisme",children:e.jsxs("p",{children:["Quan escrivim ",e.jsx("code",{children:'Animal rex = new Gos("Rex")'}),", la variable té",e.jsx("strong",{children:" dos tipus alhora"}),":"]})}),e.jsxs(oe,{children:[e.jsxs(U,{title:"Tipus Estàtic (la variable)",variant:"blue",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Animal"}),' rex = new Gos("Rex");']}),e.jsxs("p",{style:{marginTop:"8px"},children:["El tipus que veu el ",e.jsx("strong",{children:"compilador"}),". Determina quins mètodes pots ",e.jsx("strong",{children:"cridar"})," (només els d'Animal)."]}),e.jsx("p",{style:{marginTop:"8px",fontStyle:"italic"},children:'"Què puc fer amb aquesta variable?"'})]}),e.jsxs(U,{title:"Tipus Dinàmic (l'objecte real)",variant:"good",children:[e.jsxs("p",{children:["Animal rex = new ",e.jsx("strong",{children:"Gos"}),'("Rex");']}),e.jsxs("p",{style:{marginTop:"8px"},children:["El tipus real de l'objecte a ",e.jsx("strong",{children:"memòria"}),". Determina quina",e.jsx("strong",{children:" versió"})," del mètode s'executa."]}),e.jsx("p",{style:{marginTop:"8px",fontStyle:"italic"},children:'"Com es comporta realment?"'})]})]}),e.jsx(g,{label:"Tipus estàtic vs dinàmic en acció",code:LE,showLineNumbers:!0}),e.jsx(h,{variant:"warning",title:"Regla d'or",children:e.jsxs("p",{children:["El ",e.jsx("strong",{children:"compilador"})," (tipus estàtic) decideix si el codi és ",e.jsx("strong",{children:"legal"}),".",e.jsx("br",{}),"La ",e.jsx("strong",{children:"JVM en execució"})," (tipus dinàmic) decideix quin mètode ",e.jsx("strong",{children:"s'executa"}),"."]})}),e.jsx(S,{title:"Polimorfisme amb Col·leccions"}),e.jsx(h,{variant:"info",title:"On brilla el polimorfisme",children:e.jsxs("p",{children:["La potència real del polimorfisme apareix quan treballem amb ",e.jsx("strong",{children:"col·leccions"}),". Un array o ArrayList de tipus ",e.jsx("code",{children:"Animal"})," pot contenir Gossos, Gats, Ocells...",e.jsx("strong",{children:" tots barrejats!"})]})}),e.jsx(g,{label:"Array polimòrfic",code:RE,showLineNumbers:!0}),e.jsx(g,{label:"ArrayList polimòrfic",code:ME,showLineNumbers:!0}),e.jsx(h,{variant:"success",title:"Per què és tan potent?",children:e.jsxs("ul",{style:{paddingLeft:"20px",marginTop:"8px"},children:[e.jsxs("li",{children:["El ",e.jsx("strong",{children:"mateix bucle"})," funciona per a qualsevol animal, ara i en el futur."]}),e.jsxs("li",{children:["Si demà creem una classe ",e.jsx("code",{children:"Serp extends Animal"}),", el bucle ",e.jsx("strong",{children:"ja funciona"})," sense canvis."]}),e.jsxs("li",{children:["Això es diu ",e.jsx("strong",{children:"codi obert a l'extensió, tancat a la modificació"})," (principi Open/Closed)."]})]})}),e.jsx(S,{title:"instanceof i Casting"}),e.jsx(h,{variant:"explanation",children:e.jsxs("p",{children:["De vegades necessitem saber el ",e.jsx("strong",{children:"tipus real"})," d'un objecte per accedir a mètodes que ",e.jsx("strong",{children:"no existeixen a la classe pare"}),". Per això tenim",e.jsx("code",{children:" instanceof"})," i el ",e.jsx("strong",{children:"casting"}),"."]})}),e.jsx(g,{label:"instanceof: comprovar el tipus real",code:TE,showLineNumbers:!0}),e.jsx(g,{label:"Downcasting: convertir al tipus real",code:PE,showLineNumbers:!0}),e.jsx(J,{headers:["Concepte","Direcció","Exemple","Risc"],rows:[{cells:["Upcasting","Fill → Pare",'Animal a = new Gos("Rex")',"Cap (automàtic)"]},{cells:["Downcasting","Pare → Fill","Gos g = (Gos) animal","ClassCastException si el tipus no coincideix"]}]}),e.jsx(h,{variant:"warning",title:"Regla important",children:e.jsxs("p",{children:[e.jsx("strong",{children:"Sempre"})," comprova amb ",e.jsx("code",{children:"instanceof"})," abans de fer downcasting. Si no ho fas i el tipus no coincideix, el programa llançarà una",e.jsx("code",{children:" ClassCastException"})," en temps d'execució."]})}),e.jsx(S,{title:"Sobrecàrrega vs Sobreescriptura"}),e.jsx(h,{variant:"info",children:e.jsxs("p",{children:["Aquests dos conceptes es confonen sovint perquè els noms es semblen. Però són coses ",e.jsx("strong",{children:"molt diferents"}),":"]})}),e.jsxs(oe,{children:[e.jsxs(U,{title:"Sobrecàrrega (Overload)",variant:"blue",children:[e.jsxs("p",{style:{marginBottom:"8px"},children:[e.jsx("strong",{children:"Mateixa classe"}),", mateix nom, ",e.jsx("strong",{children:"diferents paràmetres"}),". Es resol en temps de ",e.jsx("strong",{children:"compilació"}),"."]}),e.jsx(g,{code:`// 3 metodes amb el MATEIX nom
...
}`}),e.jsx(h,{variant:"explanation",title:"Composició",children:e.jsxs("p",{children:["Fixa't que la classe ",e.jsx("code",{children:"Llibre"})," té un atribut de tipus ",e.jsx("code",{children:"Autor"}),". Això s'anomena ",e.jsx("strong",{children:"composició"}),`: un objecte conté un altre objecte. És una relació "TÉ UN" (un llibre TÉ UN autor). Així evitem duplicar les dades de l'autor en cada llibre.`]})}),e.jsx(S,{title:"Classe Biblioteca"}),e.jsx(g,{label:"gestio/Biblioteca.java",showLineNumbers:!0,code:`package gestio;
...
public class Main {
  ...
  app/
    Main.java         (20 línies)`})})]}),e.jsx(h,{variant:"info",title:"Recorda",children:e.jsxs("p",{children:["El primer pas per millorar el teu codi és ",e.jsx("strong",{children:"identificar les responsabilitats"})," del teu programa i crear una classe per a cadascuna. A la següent pàgina veurem com fer-ho pas a pas amb un exemple concret."]})})]})}function nC(){return e.jsxs("div",{children:[e.jsx(S,{title:"Packages: Organització del Codi"}),e.jsx(h,{variant:"info",title:"Què és un package?",children:e.jsxs("p",{children:["Un ",e.jsx("strong",{children:"package"})," és una carpeta que agrupa classes relacionades. És la manera que té Java d'organitzar el codi en projectes grans. Cada fitxer ",e.jsx("code",{children:".java"})," declara a quin package pertany, i per utilitzar classes d'un altre package cal importar-les."]})}),e.jsx(S,{title:"Estructura de Carpetes"}),e.jsx(h,{variant:"explanation",children:e.jsxs("p",{children:["L'estructura de carpetes del projecte ha de coincidir amb la declaració dels packages. Cada package és una carpeta, i cada classe és un fitxer",e.jsx("code",{children:".java"})," dins d'aquesta carpeta."]})}),e.jsx(g,{label:"Estructura de carpetes d'un projecte",language:"bash",code:`el-meu-projecte/
  src/
    utils/                          ← Package "utils"
...
}`}),e.jsx(h,{variant:"success",children:e.jsx("p",{children:"Queda clar quines classes s'estan usant."})})]}),e.jsxs(T,{title:"Import amb Comodí (*)",variant:"yellow",children:[e.jsxs("p",{children:["Importa ",e.jsx("strong",{children:"totes"})," les classes d'un package."]}),e.jsx(g,{code:`package app;
...
}`}),e.jsx(h,{variant:"warning",children:e.jsx("p",{children:"Més còmode, però menys clar. No saps quines classes s'usen realment."})})]}),e.jsxs(T,{title:"Nom Qualificat",variant:"green",children:[e.jsxs("p",{children:["Usa el nom complet ",e.jsx("strong",{children:"sense import"}),"."]}),e.jsx(g,{code:`package app;
...
}`})})]}),e.jsx(S,{title:"Resum"}),e.jsx(J,{headers:["Característica","for tradicional","for-each"],rows:[{cells:["Accés a l'índex","Sí","No"]},{cells:["Modificar l'array","Sí","No (modifica còpia)"]},{cells:["Recórrer parcialment","Sí","No (sempre recorre tot)"]},{cells:["Recórrer al revés","Sí","No"]},{cells:["Llegibilitat","Correcta","Més neta i curta"]},{cells:["Funciona amb ArrayList","Sí (.get/.size)","Sí (directament)"]}]}),e.jsx(h,{variant:"success",title:"Consell",children:e.jsxs("p",{children:["Domina primer el ",e.jsx("strong",{children:"for tradicional"}),", que és el que trobaràs a la majoria d'exercicis i exàmens. Un cop el tinguis clar, el for-each et serà molt fàcil d'incorporar com a eina complementària."]})})]})}function $C(){return e.jsxs("div",{children:[e.jsx(S,{title:"Operador Ternari: if-else compacte en una línia"}),e.jsxs(h,{variant:"info",children:[e.jsxs("p",{children:["L'operador ternari és una forma ",e.jsx("strong",{children:"compacta"})," d'escriure un if-else senzill en una sola línia. És útil quan vols assignar un valor a una variable en funció d'una condició simple."]}),e.jsxs("p",{style:{marginTop:"8px"},children:["Recorda: el ",e.jsx("strong",{children:"if-else tradicional"})," segueix sent la forma estàndard i prioritària. L'operador ternari és un complement per a casos concrets."]})]}),e.jsx(S,{title:"Sintaxi"}),e.jsx(g,{label:"Estructura de l'operador ternari",code:"variable = condicio ? valorSiTrue : valorSiFalse;"}),e.jsx(h,{variant:"explanation",children:e.jsxs("p",{children:["Es llegeix com: ",e.jsx("strong",{children:'"Si la condició és certa, agafa el primer valor; si no, agafa el segon."'})]})}),e.jsxs(T,{title:"Esquema mental",variant:"blue",children:[e.jsx("p",{children:"CONDICIÓ → si TRUE → valor A"}),e.jsx("p",{children:"CONDICIÓ → si FALSE → valor B"})]}),e.jsx(S,{title:"Comparació: if-else vs ternari"}),e.jsxs(oe,{children:[e.jsx(U,{title:"If-else tradicional (5+ línies)",variant:"blue",children:e.jsx(g,{code:`String resultat;

if (nota >= 5) {
    resultat = "Aprovat";
} else {
    resultat = "Suspes";
}`})}),e.jsx(U,{title:"Operador ternari (1 línia)",variant:"good",children:e.jsx(g,{code:'String resultat = (nota >= 5) ? "Aprovat" : "Suspes";'})})]}),e.jsx(h,{variant:"explanation",children:e.jsx("p",{children:"Ambdós codis fan exactament el mateix. La diferència és purament estètica: el ternari és més compacte, però el if-else és més explícit i fàcil de llegir per a qui comença."})}),e.jsx(S,{title:"Casos d'ús pràctics"}),e.jsx(g,{label:"1. Assignar una variable segons una condició",showLineNumbers:!0,code:`int edat = 20;
...
System.out.println("Valor absolut: " + absolut); // 42`}),e.jsx(S,{title:"Ternari aniuat (existeix, però no el recomanem)"}),e.jsx(h,{variant:"warning",title:"Evita els ternaris aniuats",children:e.jsxs("p",{children:["Tècnicament és possible encadenar ternaris, però el resultat és un codi molt difícil de llegir i mantenir. ",e.jsx("strong",{children:"No ho recomanem."})]})}),e.jsxs(oe,{children:[e.jsx(U,{title:"Ternari aniuat (difícil de llegir)",variant:"bad",children:e.jsx(g,{code:`// NO recomanat!
...
if (edat < 12) {
    ...
    categoria = "Jubilat";
}`})})]}),e.jsx(S,{title:"Quan utilitzar i quan NO"}),e.jsxs(me,{children:[e.jsx(T,{title:"Utilitza l'operador ternari quan...",variant:"green",children:e.jsxs("ul",{style:{marginTop:"8px",paddingLeft:"20px"},children:[e.jsx("li",{children:"La decisió és simple: una condició, dos valors possibles"}),e.jsx("li",{children:"Vols assignar un valor a una variable en una sola línia"}),e.jsx("li",{children:"Vols retornar un valor senzill des d'un mètode"}),e.jsx("li",{children:"El codi resultant segueix sent fàcil de llegir"})]})}),e.jsx(T,{title:"NO utilitzis l'operador ternari quan...",variant:"pink",children:e.jsxs("ul",{style:{marginTop:"8px",paddingLeft:"20px"},children:[e.jsx("li",{children:"La lògica és complexa o té múltiples condicions"}),e.jsx("li",{children:"Necessites executar varies instruccions (no només retornar un valor)"}),e.jsx("li",{children:"Voldries aniuar ternaris dins d'altres ternaris"}),e.jsx("li",{children:"El codi es fa difícil d'entendre a primera vista"})]})})]}),e.jsx(S,{title:"Resum"}),e.jsx(J,{headers:["Característica","if-else","Operador ternari"],rows:[{cells:["Línies de codi","5+ línies","1 línia"]},{cells:["Llegibilitat","Molt clara","Clara si és simple"]},{cells:["Múltiples instruccions","Sí","No (només retorna un valor)"]},{cells:["Condicions complexes","Sí","No recomanat"]},{cells:["Aniuament","Fàcil de llegir","Molt confús"]},{cells:["Ús principal","Qualsevol decisió","Assignacions simples"]}]}),e.jsx(h,{variant:"success",title:"Consell",children:e.jsxs("p",{children:["Pensa en l'operador ternari com un ",e.jsx("strong",{children:"atall"}),": si el caminet curt és clar i segur, pren-lo. Si és fosc i ple de revolts (condicions complexes), millor el camí principal (if-else)."]})})]})}function VC(){return e.jsxs("div",{children:[e.jsx(S,{title:"var i altres funcionalitats modernes de Java"}),e.jsxs(h,{variant:"info",children:[e.jsxs("p",{children:["Java ha anat evolucionant amb noves versions que incorporen sintaxis més modernes i compactes. Aquí veurem algunes de les més útils: ",e.jsx("strong",{children:"var"}),","," ",e.jsx("strong",{children:"text blocks"}),", ",e.jsx("strong",{children:"switch expressions"})," i"," ",e.jsx("strong",{children:"records"}),"."]}),e.jsxs("p",{style:{marginTop:"8px"},children:["Totes aquestes funcionalitats són ",e.jsx("strong",{children:"complements"})," a la sintaxi tradicional, que segueix sent la prioritat a nivell acadèmic."]})]}),e.jsx(h,{variant:"warning",title:"Important per a estudiants de DAM",children:e.jsxs("p",{children:["Aquestes funcionalitats són ",e.jsx("strong",{children:'"nice to know"'})," (bo de saber). A nivell de DAM, centra't primer en la sintaxi tradicional que és la que apareixerà als exàmens i exercicis. Coneix-les per si les trobes en codi real o tutorials moderns."]})}),e.jsx(S,{title:"var: inferència de tipus local (Java 10+)"}),e.jsx(h,{variant:"info",children:e.jsxs("p",{children:["La paraula clau ",e.jsx("strong",{children:"var"})," permet declarar variables locals sense especificar explícitament el tipus. El compilador ",e.jsx("strong",{children:"dedueix"})," el tipus automàticament a partir del valor assignat."]})}),e.jsxs(oe,{children:[e.jsx(U,{title:"Forma tradicional (tipus explícit)",variant:"blue",children:e.jsx(g,{code:`String nom = "Hola";
int edat = 25;
double preu = 19.99;
...
var llista = new ArrayList<String>();`})})]}),e.jsx(h,{variant:"explanation",children:e.jsxs("p",{children:["En ambdós casos, el tipus és ",e.jsx("strong",{children:"exactament el mateix"}),". L'única diferència és que amb ",e.jsx("code",{children:"var"})," no l'escrius tu, el compilador el dedueix. Un cop assignat, el tipus queda fixat."]})}),e.jsx(h,{variant:"error",title:"var NO fa que Java sigui dinàmic!",children:e.jsxs("p",{children:["A diferència de Python o JavaScript, ",e.jsx("code",{children:"var"})," ",e.jsx("strong",{children:"no"})," converteix Java en un llenguatge de tipat dinàmic. El tipus es determina en temps de compilació i no pot canviar després."]})}),e.jsx(g,{label:"Això dona ERROR de compilació",code:`var x = 10;       // x es int
...
var config = inicialitzar();`})]})]}),e.jsx(S,{title:"Text blocks: strings multilínia (Java 13+)"}),e.jsx(h,{variant:"info",children:e.jsxs("p",{children:["Els ",e.jsx("strong",{children:"text blocks"})," permeten escriure cadenes de text de múltiples línies sense haver de concatenar ni usar ",e.jsx("code",{children:"\\n"}),". S'utilitzen tres cometes dobles ",e.jsx("code",{children:'"""'})," per obrir i tancar."]})}),e.jsxs(oe,{children:[e.jsx(U,{title:"Forma tradicional",variant:"blue",children:e.jsx(g,{code:`String json = "{\\n" +
    "  \\"nom\\": \\"Anna\\",\\n" +
    "  \\"edat\\": 25\\n" +
...
String menu = """
    ...
    3. Sortir
    ===================""";
System.out.println(menu);`}),e.jsx(S,{title:"Switch expressions: switch que retorna valor (Java 14+)"}),e.jsx(h,{variant:"info",children:e.jsxs("p",{children:["Les ",e.jsx("strong",{children:"switch expressions"})," són una versió millorada del switch que pot retornar un valor directament, utilitza fletxes (",e.jsx("code",{children:"->"}),") en comptes de ",e.jsx("code",{children:"case/break"}),", i és més compacte."]})}),e.jsxs(oe,{children:[e.jsx(U,{title:"Switch tradicional",variant:"blue",children:e.jsx(g,{code:`String nomDia;
switch (dia) {
    case 1:
        nomDia = "Dilluns";
        break;
    ...
    case 3 -> "Dimecres";
    default -> "Desconegut";
};`})})]}),e.jsx(h,{variant:"explanation",children:e.jsxs("p",{children:["Avantatges del switch expression: no necessita ",e.jsx("code",{children:"break"})," (no hi ha fall-through accidental), pot retornar valors directament, i permet agrupar casos fàcilment."]})}),e.jsx(g,{label:"Agrupar múltiples casos",code:`String tipusDia = switch (dia) {
    case 1, 2, 3, 4, 5 -> "Laborable";
    case 6, 7           -> "Cap de setmana";
    default             -> "Invalid";
};`}),e.jsx(S,{title:"Records: classes de dades simplificades (Java 16+)"}),e.jsx(h,{variant:"info",children:e.jsxs("p",{children:["Els ",e.jsx("strong",{children:"records"})," són una forma molt compacta de crear classes que només serveixen per guardar dades (com un DTO). Java genera automàticament el constructor, getters, ",e.jsx("code",{children:"equals()"}),", ",e.jsx("code",{children:"hashCode()"})," i"," ",e.jsx("code",{children:"toString()"}),"."]})}),e.jsxs(oe,{children:[e.jsx(U,{title:"Classe tradicional",variant:"blue",children:e.jsx(g,{code:`public class Punt {
    private final int x;
    private final int y;
...
System.out.println(p);     // Punt[x=3, y=5]`})})]}),e.jsx(h,{variant:"warning",title:"Limitacions dels records",children:e.jsxs("p",{children:["Els records són ",e.jsx("strong",{children:"immutables"})," (no tenen setters), no poden heretar d'altres classes, i els seus camps són finals. Són ideals per a dades simples, però no substitueixen les classes normals amb lògica complexa."]})}),e.jsx(S,{title:"Resum de funcionalitats modernes"}),e.jsx(J,{headers:["Funcionalitat","Versió de Java","Per a què serveix","Prioritat a DAM"],rows:[{cells:["var","Java 10+","Inferència de tipus en variables locals","Útil però no essencial"]},{cells:['Text blocks (""")',"Java 13+","Strings multilínia sense \\n","Bo de saber"]},{cells:["Switch expressions","Java 14+","Switch que retorna valor, sense break","Bo de saber"]},{cells:["Records","Java 16+","Classes de dades compactes","Avançat, bo de saber"]}]}),e.jsx(h,{variant:"success",title:"Consell final",children:e.jsxs("p",{children:["Totes aquestes funcionalitats fan el codi més curt i modern, però la base de Java ",e.jsx("strong",{children:"segueix sent la mateixa"}),". Aprendre la sintaxi tradicional primer et garanteix entendre qualsevol codi Java, sigui antic o modern. Aquestes eines modernes les aniràs incorporant naturalment a mesura que guanyis experiència."]})})]})}function QC(){return e.jsxs("div",{children:[e.jsx(S,{title:"Com es pica codi en equip"}),e.jsxs(h,{variant:"info",title:"Que veurem aqui?",children:[e.jsxs("p",{children:["A ",e.jsx("strong",{children:"Anatomia d'un Projecte Real"})," heu vist COM es dissenya i estructura un projecte des de zero. Aqui veurem la part que falta:",e.jsx("strong",{children:" com es treballa dia a dia amb aquest codi"}),". Com fas servir Git quan sou 5 persones tocant el mateix projecte. Que passa quan obres un fitxer que no has escrit tu. Com trobes i arregles un bug. Com evites que el projecte es converteixi en un caos."]}),e.jsx("p",{style:{marginTop:"8px"},children:"Res de teoria abstracta: tot son situacions reals que viureu des del primer dia de feina."})]}),e.jsx(S,{title:"El teu primer dia: clonar i entendre el projecte"}),e.jsx(h,{variant:"explanation",title:"Arribes a una empresa, t'assignen un projecte. Ara que?",children:e.jsxs("p",{children:["Quan arribes a un equip, el projecte ja existeix. Pot tenir ",e.jsx("strong",{children:"milers de fitxers"})," ","escrits durant mesos o anys per persones que potser ja no hi treballen. El teu primer objectiu no es programar: es ",e.jsx("strong",{children:"entendre que hi ha"}),"."]})}),e.jsx(g,{label:"Pas 1: Clonar el projecte i fer-lo funcionar",showLineNumbers:!0,code:`# El teu company et passa el link del repositori
...
# Si no entens per que, pots preguntar-li directament o mirar el commit e8c3d6f.`}),e.jsx(S,{title:"Manteniment: el codi creix i s'ha de cuidar"}),e.jsx(h,{variant:"explanation",title:"El codi es com un jardi",children:e.jsxs("p",{children:["Si ningu el cuida, creix descontrolat. Les males herbes (codi duplicat, funcions massa llargues, noms confusos) s'acumulen poc a poc fins que el projecte es inmantenible. Per aixo existeix el ",e.jsx("strong",{children:"refactoring"}),": canviar l'estructura del codi ",e.jsx("strong",{children:"sense canviar el que fa"})," per mantenir-lo net."]})}),e.jsxs(oe,{children:[e.jsx(U,{title:"Codi que necessita refactoring",variant:"bad",children:e.jsx(g,{code:`// Metode de 80 linies que fa 5 coses
...
public String saluda(
    ...
    model.addAttribute("nom", nom);
    return "hola";
}`;function mw(){return e.jsxs("div",{children:[e.jsx(S,{title:"Primer Projecte: Hola Món al Navegador"}),e.jsx(S,{title:"Pas 1: Crear el Projecte a start.spring.io"}),e.jsx(h,{variant:"info",title:"Spring Initializr: el creador de projectes",children:e.jsx("div",{style:{fontSize:"1.05em",lineHeight:"1.9"},children:e.jsxs("p",{children:["Obre el navegador i ves a ",e.jsx("strong",{children:"start.spring.io"}),". Aquesta web crea l'esquelet del projecte amb tota la configuració feta. Només has de triar les opcions i descarregar el .zip."]})})}),e.jsx(g,{label:"Configuració a start.spring.io",code:aw}),e.jsx(J,{headers:["Camp","Valor","Per què"],rows:[{cells:["Project","Maven","Gestor de dependències (el més usat amb Spring)"]},{cells:["Language","Java","El que ja sabeu!"]},{cells:["Spring Boot","3.4.x","La versió estable més recent"]},{cells:["Group","com.exemple","Identifica la vostra organització (com el package)"]},{cells:["Artifact","holamundo","El nom del projecte"]},{cells:["Packaging","Jar","Format de distribució (el més senzill)"]},{cells:["Java","21","Versió de Java (la que useu habitualment a classe)"]}]}),e.jsx(h,{variant:"warning",title:"Dependencies: no us les oblideu!",children:e.jsxs("div",{style:{fontSize:"1.05em",lineHeight:"1.9"},children:[e.jsxs("p",{children:["Cliqueu ",e.jsx("strong",{children:"ADD DEPENDENCIES"})," i afegiu:"]}),e.jsxs("ul",{style:{paddingLeft:"20px",marginTop:"8px"},children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Spring Web"})," — per crear aplicacions web (controllers, peticions HTTP)"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Thymeleaf"})," — per crear pàgines HTML dinàmiques des de Java"]})]}),e.jsxs("p",{style:{marginTop:"8px"},children:["Cliqueu ",e.jsx("strong",{children:"GENERATE"}),", descarregueu el .zip, descomprimiu-lo i obriu la carpeta amb el vostre IDE:"]}),e.jsxs("ul",{style:{paddingLeft:"20px",marginTop:"8px"},children:[e.jsxs("li",{children:[e.jsx("strong",{children:"IntelliJ IDEA"}),": File → Open → seleccioneu la carpeta del projecte."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"VS Code"}),": File → Open Folder → seleccioneu la carpeta del projecte. Assegureu-vos de tenir instal·lats ",e.jsx("em",{children:"Extension Pack for Java"})," i",e.jsx("em",{children:" Spring Boot Extension Pack"}),"."]})]})]})}),e.jsxs(h,{variant:"explanation",title:"Primera vegada amb l'IDE?",children:[e.jsx("p",{children:"Quan obriu el projecte per primera vegada, l'IDE descarregarà les dependències automàticament. Pot trigar 1-2 minuts. Espereu fins que la barra de progrés de baix desaparegui."}),e.jsxs("ul",{style:{paddingLeft:"20px",marginTop:"8px"},children:[e.jsxs("li",{children:[e.jsx("strong",{children:"IntelliJ IDEA"}),': Si us demana "Trust Project", cliqueu que sí.']}),e.jsxs("li",{children:[e.jsx("strong",{children:"VS Code"}),": Accepteu la notificació per importar el projecte Maven."]})]})]}),e.jsx(S,{title:"Pas 2: Entendre el que ja existeix"}),e.jsx(h,{variant:"info",children:e.jsxs("p",{children:["Després de descomprimir, el projecte ja té fitxers creats. El més important és ",e.jsx("code",{children:"HolamundoApplication.java"}),", que és el punt d'entrada (com el ",e.jsx("code",{children:"Main"})," que ja coneixeu):"]})}),e.jsx(g,{label:"HolamundoApplication.java (generat automàticament)",code:rw,showLineNumbers:!0}),e.jsx(h,{variant:"explanation",title:"Què fa exactament @SpringBootApplication?",children:e.jsxs("div",{style:{fontSize:"1.05em",lineHeight:"1.9"},children:[e.jsxs("p",{children:["Aquesta anotació ",e.jsx("strong",{children:"no és màgia"}),". És una combinació de tres anotacions que fan tres coses concretes:"]}),e.jsxs("ul",{style:{paddingLeft:"20px",marginTop:"8px"},children:[e.jsxs("li",{children:[e.jsx("strong",{children:"@ComponentScan"})," — Recorre totes les classes del package (",e.jsx("code",{children:"com.exemple.holamundo"}),") i subpackages buscant classes amb anotacions com ",e.jsx("code",{children:"@Controller"}),", ",e.jsx("code",{children:"@Service"}),",",e.jsx("code",{children:" @Repository"}),". Les registra perquè Spring les pugui usar.",e.jsx("br",{}),e.jsx("em",{children:"Per això cal que els Controllers estiguin dins del mateix package principal o subpackages."})]}),e.jsxs("li",{style:{marginTop:"6px"},children:[e.jsx("strong",{children:"@EnableAutoConfiguration"})," — Mira què hi ha al",e.jsx("code",{children:" pom.xml"})," (les dependències) i configura Spring en conseqüència. Heu afegit ",e.jsx("code",{children:"spring-boot-starter-web"}),"? Doncs arranca un servidor web. Heu afegit ",e.jsx("code",{children:"spring-boot-starter-thymeleaf"}),"? Doncs prepara Thymeleaf. Tot automàtic segons el que necessiteu."]}),e.jsxs("li",{style:{marginTop:"6px"},children:[e.jsx("strong",{children:"@SpringBootConfiguration"})," — Marca aquesta classe com a classe de configuració principal de l'aplicació."]})]})]})}),e.jsx(h,{variant:"info",title:"I el mètode main()?",children:e.jsxs("div",{style:{fontSize:"1.05em",lineHeight:"1.9"},children:[e.jsxs("p",{children:["És el ",e.jsx("code",{children:"main()"})," Java de tota la vida, el mateix que feieu a consola. La línia ",e.jsx("code",{children:"SpringApplication.run(HolamundoApplication.class, args)"})," fa tres coses:"]}),e.jsxs("ul",{style:{paddingLeft:"20px",marginTop:"8px"},children:[e.jsx("li",{children:"Llegeix les anotacions de la classe i aplica la configuració"}),e.jsxs("li",{children:["Arranca el ",e.jsx("strong",{children:"servidor web Tomcat"})," (que Spring porta incrustat)"]}),e.jsxs("li",{children:["Es queda escoltant al port ",e.jsx("strong",{children:"8080"})," peticions del navegador"]})]}),e.jsxs("p",{style:{marginTop:"8px"},children:["Normalment ",e.jsx("strong",{children:"no caldrà que toqueu aquest fitxer"}),", però ara ja sabeu què fa cada línia. Res de màgia."]})]})}),e.jsx(S,{title:"Pas 3: Crear el Controller"}),e.jsx(h,{variant:"success",title:"El Controller: on arriben les peticions",children:e.jsxs("div",{style:{fontSize:"1.05em",lineHeight:"1.9"},children:[e.jsxs("p",{children:["El ",e.jsx("strong",{children:"Controller"})," és la classe que rep les peticions del navegador i decideix què retornar. És com el ",e.jsx("code",{children:"Menu.java"})," que fèieu a consola, però en lloc de ",e.jsx("code",{children:"System.out"}),", retorna pàgines HTML."]}),e.jsxs("p",{style:{marginTop:"8px"},children:["Creeu la carpeta ",e.jsx("code",{children:"controller/"})," dins del package principal i afegiu aquest fitxer:"]})]})}),e.jsx(g,{label:"HolaController.java (CREEU-LO VOSALTRES)",code:nw,showLineNumbers:!0}),e.jsx(h,{variant:"explanation",title:"Línia per línia: què fa cada cosa?",children:e.jsx("p",{children:"Desglossem el controller:"})}),e.jsx(g,{label:"El Controller explicat pas a pas",code:iw,showLineNumbers:!0}),e.jsx(J,{headers:["Element","Què fa","Equivalent a consola"],rows:[{cells:["@Controller",'Diu a Spring: "aquesta classe rep peticions"',"No tenia equivalent"]},{cells:['@GetMapping("/hola")',"Quan el navegador visita /hola, executa aquest mètode","case 1: del switch al Menu"]},{cells:["Model model",'Una "motxilla" per passar dades al HTML',"Les variables que passàveu a System.out"]},{cells:["model.addAttribute()","Posa una dada dins la motxilla","Preparar el text per mostrar"]},{cells:['return "hola"',"Retorna la pàgina templates/hola.html","El System.out que mostrava el resultat"]}]}),e.jsx(S,{title:"Pas 4: Crear les Pàgines HTML"}),e.jsx(h,{variant:"info",title:"Per què existeix Thymeleaf? El problema que soluciona",children:e.jsxs("div",{style:{fontSize:"1.05em",lineHeight:"1.9"},children:[e.jsxs("p",{children:["Imaginem que volem mostrar un nom dinàmic a una pàgina HTML. ",e.jsx("strong",{children:"Sense Thymeleaf"}),", hauríem de construir l'HTML com un String dins del codi Java:"]}),e.jsx(g,{code:`// HORRIBLE: construir HTML com a String
@GetMapping("/hola")
public String hola() {
    String nom = "Mundo";
    return "<html><body>"
...
//
// GENERATE -> descomprimir -> obrir amb IntelliJ / VS Code`,fw=`// src/main/java/com/exemple/endevinaanimal/model/Animal.java
...
// accessible al navegador a: http://localhost:8080/images/gos.jpg`,gw=`<!-- Al tag <head> de cada pagina HTML: -->

<head>
    <meta charset="UTF-8">
    <title>Endevina l'Animal</title>

    <!-- Bootstrap 5 per CDN: una sola linia i tot es veu professional -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css"
          rel="stylesheet">
</head>

<!-- I a partir d'ara, pots usar classes com: -->
<!-- btn btn-primary, card, container, row, col-md-6, etc. -->
<!-- Mira bootstrap.com/docs per veure tots els components -->`,jw=`// src/main/java/com/exemple/endevinaanimal/controller/JocController.java
...
}`,vw=`<!-- src/main/resources/templates/joc.html -->
...
</html>`,bw=`<!-- src/main/resources/templates/encertat.html -->
...
└── pom.xml`,Sw=`// Que passa quan l'usuari escriu "Gos" i clica "Endevinar"?
...
// CONTROLLER -> JocController.java (coordina)`,Ew=`// REPTE per al proxim dia (no cal fer-ho ara)
//
...
}`}),e.jsx(J,{headers:["Tipus de test","Que prova","Exemple"],rows:[{cells:["Unitari","Una sola classe o metode, aillat","TaulaTest: comprova que potAcollir() funciona correctament"]},{cells:["Integracio","Multiples classes juntes","ServeiReservesTest: comprova que ferReserva() crea una reserva i ocupa la taula"]},{cells:["End-to-End","Tot el sistema, de frontend a BD","Simula un usuari fent una reserva des de l'app"]}]}),e.jsx(S,{title:"4. CI/CD: automatitzar tot el proces"}),e.jsxs(h,{variant:"explanation",title:"Que es CI/CD?",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"CI"})," (Continuous Integration): cada cop que algu fa push, automaticament s'executen els tests. Si falla algun, tothom ho sap immediatament."]}),e.jsxs("p",{style:{marginTop:"8px"},children:[e.jsx("strong",{children:"CD"})," (Continuous Deployment): si tots els tests passen, l'aplicacio es desplega automaticament al servidor."]})]}),e.jsx(qe,{src:"projecte-cicd",title:"Pipeline CI/CD"}),e.jsx(g,{label:".github/workflows/ci.yml (GitHub Actions)",showLineNumbers:!0,code:`name: CI Pipeline
...
└── controlador/
    └── ControladorReserves.java # Connecta model i vista`,label:"Estructura de carpetes amb MVC",showLineNumbers:!0}),e.jsx(h,{variant:"info",title:"El Controller: el director d'orquestra",children:e.jsxs("p",{children:["El Controlador rep l'accio de l'usuari (via la Vista), opera amb el Model i torna a la Vista per mostrar resultats. Fixa't que ",e.jsx("strong",{children:"mai"}),"fa ",e.jsx("code",{children:"System.out.println"})," directament: aixo es feina de la Vista."]})}),e.jsx(g,{code:`public class ControladorReserves {
...
}`,label:"Controlador de Reserves",showLineNumbers:!0}),e.jsx(S,{title:"On trobaras MVC?"}),e.jsx(h,{variant:"info",title:"MVC es a tot arreu",children:e.jsx("p",{children:"Practicament tots els frameworks moderns utilitzen MVC o una variant. Aqui teniu exemples reals:"})}),e.jsx(J,{headers:["Plataforma","Tecnologia","Com aplica MVC"],rows:[{cells:["Java Web","Spring MVC (Spring Boot)","Controllers reben peticions HTTP, Models son les entitats, Vistes son plantilles HTML"]},{cells:["Android","Activities + Layouts + ViewModel","XML layouts (Vista), Activities/ViewModel (Controller), classes de dades (Model)"]},{cells:["Web Frontend","React, Angular, Vue","Components (Vista), estat/stores (Model), gestors d'events (Controller)"]},{cells:["Desktop","JavaFX (FXML + Controller)","Fitxers FXML (Vista), classes Controller, classes de dades (Model)"]},{cells:["Jocs","Unity (C#)","Usa una variant de MVC per separar logica de joc, renderitzat i input"]}]}),e.jsx(S,{title:"Connexio amb el que heu apres"}),e.jsxs(h,{variant:"explanation",title:"Ja teniu les peces!",children:[e.jsxs("p",{children:["Tot el que heu apres fins ara (classes, objectes, encapsulacio, packages, modularitat) son els ",e.jsx("strong",{children:"blocs de construccio"})," de MVC:"]}),e.jsxs("p",{style:{marginTop:"8px"},children:["El ",e.jsx("strong",{children:"Model"})," son les vostres classes amb encapsulacio (atributs privats, getters, setters). Els ",e.jsx("strong",{children:"packages"})," son la separacio en carpetes. La ",e.jsx("strong",{children:"modularitat"})," es el principi que cada classe fa una sola cosa. MVC simplement ",e.jsx("strong",{children:"formalitza el patro"}),": us diu on posar cada peca."]})]}),e.jsxs(h,{variant:"success",title:"La idea clau",children:[e.jsxs("p",{children:["MVC es una ",e.jsx("strong",{children:"manera de pensar"})," sobre l'organitzacio del codi, no una eina nova que cal aprendre. Ja coneixeu les peces: classes, objectes, encapsulacio, packages. MVC simplement us diu ",e.jsx("strong",{children:"on posar-les"}),": les dades al Model, la presentacio a la Vista i la coordinacio al Controller."]}),e.jsx("p",{style:{marginTop:"8px"},children:"Quan comenceu a treballar amb frameworks com Spring Boot o JavaFX, veureu que tot segueix aquest patro. Si enteneu MVC, enteneu l'arquitectura de qualsevol aplicacio moderna."})]})]})}const Iw="_quizContainer_6jjjs_1",Dw="_progressBar_6jjjs_6",Fw="_progressDot_6jjjs_12",zw="_done_6jjjs_20",Bw="_correct_6jjjs_24",Uw="_wrong_6jjjs_28",Gw="_active_6jjjs_32",Hw="_questionCard_6jjjs_37",$w="_questionNumber_6jjjs_56",Vw="_questionType_6jjjs_65",Qw="_questionText_6jjjs_78",Jw="_codeContext_6jjjs_87",Ww="_codeGap_6jjjs_103",Kw="_options_6jjjs_113",Yw="_option_6jjjs_113",Xw="_disabled_6jjjs_136",Zw="_selected_6jjjs_142",eA="_optionLetter_6jjjs_162",tA="_optionCode_6jjjs_192",aA="_optionText_6jjjs_199",rA="_feedback_6jjjs_204",nA="_fadeIn_6jjjs_1",iA="_feedbackTitle_6jjjs_225",sA="_navRow_6jjjs_231",lA="_nextBtn_6jjjs_237",oA="_results_6jjjs_255",cA="_scoreCircle_6jjjs_260",uA="_great_6jjjs_273",dA="_good_6jjjs_279",pA="_low_6jjjs_285",mA="_scoreNumber_6jjjs_291",hA="_scoreLabel_6jjjs_296",fA="_resultsTitle_6jjjs_304",xA="_resultsSubtitle_6jjjs_311",gA="_resultsSummary_6jjjs_317",jA="_statBox_6jjjs_324",vA="_statNumber_6jjjs_328",bA="_green_6jjjs_333",yA="_red_6jjjs_334",SA="_statLabel_6jjjs_336",EA="_retryBtn_6jjjs_343",ie={quizContainer:Iw,progressBar:Dw,progressDot:Fw,done:zw,correct:Bw,wrong:Uw,active:Gw,questionCard:Hw,questionNumber:$w,questionType:Vw,questionText:Qw,codeContext:Jw,codeGap:Ww,options:Kw,option:Yw,disabled:Xw,selected:Zw,optionLetter:eA,optionCode:tA,optionText:aA,feedback:rA,fadeIn:nA,feedbackTitle:iA,navRow:sA,nextBtn:lA,results:oA,scoreCircle:cA,great:uA,good:dA,low:pA,scoreNumber:mA,scoreLabel:hA,resultsTitle:fA,resultsSubtitle:xA,resultsSummary:gA,statBox:jA,statNumber:vA,green:bA,red:yA,statLabel:SA,retryBtn:EA},CA=["A","B","C","D"];function wA({questions:t,onFinish:a}){const[r,n]=A.useState(0),[i,s]=A.useState(null),[l,o]=A.useState(!1),[c,u]=A.useState([]),m=t[r],d=i===(m==null?void 0:m.correctIndex),x=r>=t.length,y=A.useCallback(E=>{l||(s(E),o(!0),u(f=>[...f,E===m.correctIndex]))},[l,m]),j=A.useCallback(()=>{s(null),o(!1),n(E=>E+1)},[]),b=A.useCallback(()=>{n(0),s(null),o(!1),u([])},[]);if(x){const E=c.filter(Boolean).length,f=t.length,p=Math.round(E/f*100),v=p>=80?"great":p>=50?"good":"low",R=p>=80?"Molt be! Domines MVC!":p>=50?"Bon treball! Repassa els errors.":"Cal repassar una mica mes. Torna-ho a intentar!";return e.jsxs("div",{className:ie.results,children:[e.jsxs("div",{className:`${ie.scoreCircle} ${ie[v]}`,children:[e.jsxs("span",{className:ie.scoreNumber,children:[p,"%"]}),e.jsx("span",{className:ie.scoreLabel,children:"encerts"})]}),e.jsx("h2",{className:ie.resultsTitle,children:R}),e.jsxs("p",{className:ie.resultsSubtitle,children:["Has encertat ",E," de ",f," preguntes"]}),e.jsxs("div",{className:ie.resultsSummary,children:[e.jsxs("div",{className:ie.statBox,children:[e.jsx("div",{className:`${ie.statNumber} ${ie.green}`,children:E}),e.jsx("div",{className:ie.statLabel,children:"Correctes"})]}),e.jsxs("div",{className:ie.statBox,children:[e.jsx("div",{className:`${ie.statNumber} ${ie.red}`,children:f-E}),e.jsx("div",{className:ie.statLabel,children:"Incorrectes"})]})]}),e.jsx("button",{className:ie.retryBtn,onClick:b,children:"Torna a intentar-ho"})]})}return e.jsxs("div",{className:ie.quizContainer,children:[e.jsx("div",{className:ie.progressBar,children:t.map((E,f)=>{let p=ie.progressDot;return f<c.length?p+=` ${c[f]?ie.correct:ie.wrong}`:f===r&&(p+=` ${ie.active}`),e.jsx("div",{className:p},f)})}),e.jsxs("div",{className:`${ie.questionCard} ${l?d?ie.correct:ie.wrong:""}`,children:[e.jsxs("div",{className:ie.questionNumber,children:["Pregunta ",r+1," de ",t.length,e.jsx("span",{className:ie.questionType,children:m.type})]}),e.jsx("div",{className:ie.questionText,children:m.question}),m.code&&e.jsx("div",{className:ie.codeContext,children:e.jsx("pre",{dangerouslySetInnerHTML:{__html:m.code}})}),e.jsx("div",{className:ie.options,children:m.options.map((E,f)=>{let p=`${ie.option}`;return l?(p+=` ${ie.disabled}`,f===m.correctIndex?p+=` ${ie.correct}`:f===i&&(p+=` ${ie.wrong}`)):f===i&&(p+=` ${ie.selected}`),e.jsxs("button",{className:p,onClick:()=>y(f),children:[e.jsx("span",{className:ie.optionLetter,children:CA[f]}),e.jsx("span",{className:E.isCode?ie.optionCode:ie.optionText,children:E.text})]},f)})}),l&&e.jsxs("div",{className:`${ie.feedback} ${d?ie.correct:ie.wrong}`,children:[e.jsx("div",{className:ie.feedbackTitle,children:d?"Correcte!":"Incorrecte!"}),e.jsx("div",{children:m.explanation})]}),l&&e.jsx("div",{className:ie.navRow,children:e.jsx("button",{className:ie.nextBtn,onClick:j,children:r<t.length-1?"Seguent pregunta":"Veure resultats"})})]})]})}const AA=[{type:"On va?",question:"A quina capa MVC pertany aquest codi?",code:`<span style="color:#ffd700">public class</span> <span style="color:#e5c07b">Alumne</span> {
