 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function a(O,B){var H=O.length;O.push(B);e:for(;0<H;){var re=H-1>>>1,de=O[re];if(0<i(de,B))O[re]=B,O[H]=de,H=re;else break e}}function r(O){return O.length===0?null:O[0]}function n(O){if(O.length===0)return null;var B=O[0],H=O.pop();if(H!==B){O[0]=H;e:for(var re=0,de=O.length,ye=de>>>1;re<ye;){var Le=2*(re+1)-1,Fe=O[Le],Ee=Le+1,$e=O[Ee];if(0>i(Fe,H))Ee<de&&0>i($e,Fe)?(O[re]=$e,O[Ee]=H,re=Ee):(O[re]=Fe,O[Le]=H,re=Le);else if(Ee<de&&0>i($e,H))O[re]=$e,O[Ee]=H,re=Ee;else break e}}return B}function i(O,B){var H=O.sortIndex-B.sortIndex;return H!==0?H:O.id-B.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var l=Date,o=l.now();t.unstable_now=function(){return l.now()-o}}var c=[],u=[],h=1,d=null,x=3,y=!1,j=!1,b=!1,E=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(O){for(var B=r(u);B!==null;){if(B.callback===null)n(u);else if(B.startTime<=O)n(u),B.sortIndex=B.expirationTime,a(c,B);else break;B=r(u)}}function R(O){if(b=!1,v(O),!j)if(r(c)!==null)j=!0,G(P);else{var B=r(u);B!==null&&ae(R,B.startTime-O)}}function P(O,B){j=!1,b&&(b=!1,f(w),w=-1),y=!0;var H=x;try{for(v(B),d=r(c);d!==null&&(!(d.expirationTime>B)||O&&!le());){var re=d.callback;if(typeof re=="function"){d.callback=null,x=d.priorityLevel;var de=re(d.expirationTime<=B);B=t.unstable_now(),typeof de=="function"?d.callback=de:d===r(c)&&n(c),v(B)}else n(c);d=r(c)}if(d!==null)var ye=!0;else{var Le=r(u);Le!==null&&ae(R,Le.startTime-B),ye=!1}return ye}finally{d=null,x=H,y=!1}}var k=!1,_=null,w=-1,$=5,F=-1;function le(){return!(t.unstable_now()-F<$)}function ee(){if(_!==null){var O=t.unstable_now();F=O;var B=!0;try{B=_(!0,O)}finally{B?je():(k=!1,_=null)}}else k=!1}var je;if(typeof p=="function")je=function(){p(ee)};else if(typeof MessageChannel<"u"){var te=new MessageChannel,q=te.port2;te.port1.onmessage=ee,je=function(){q.postMessage(null)}}else je=function(){E(ee,0)};function G(O){_=O,k||(k=!0,je())}function ae(O,B){w=E(function(){O(t.unstable_now())},B)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(O){O.callback=null},t.unstable_continueExecution=function(){j||y||(j=!0,G(P))},t.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<O?Math.floor(1e3/O):5},t.unstable_getCurrentPriorityLevel=function(){return x},t.unstable_getFirstCallbackNode=function(){return r(c)},t.unstable_next=function(O){switch(x){case 1:case 2:case 3:var B=3;break;default:B=x}var H=x;x=B;try{return O()}finally{x=H}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(O,B){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var H=x;x=O;try{return B()}finally{x=H}},t.unstable_scheduleCallback=function(O,B,H){var re=t.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?re+H:re):H=re,O){case 1:var de=-1;break;case 2:de=250;break;case 5:de=1073741823;break;case 4:de=1e4;break;default:de=5e3}return de=H+de,O={id:h++,callback:B,priorityLevel:O,startTime:H,expirationTime:de,sortIndex:-1},H>re?(O.sortIndex=H,a(u,O),r(c)===null&&O===r(u)&&(b?(f(w),w=-1):b=!0,ae(R,H-re))):(O.sortIndex=de,a(c,O),j||y||(j=!0,G(P))),O},t.unstable_shouldYield=le,t.unstable_wrapCallback=function(O){var B=x;return function(){var H=x;x=B;try{return O.apply(this,arguments)}finally{x=H}}}})(Hd);Ud.exports=Hd;var yf=Ud.exports;/**
 * @license React
...
int d = 2;`}),e.jsxs(me,{children:[e.jsxs(T,{title:"AND (&&)",variant:"blue",children:[e.jsxs("p",{children:["Retorna TRUE únicament quan ",e.jsx("strong",{children:"AMBDUES"})," expressions/valors són TRUE"]}),e.jsxs("ul",{style:{marginTop:"10px",paddingLeft:"20px",listStyle:"none"},children:[e.jsx("li",{children:"(a && b) → com ambdues són true, el resultat és true."}),e.jsx("li",{children:"(a && b) && (c == d) → com ambdues expressions són true, aleshores (true && true) → true."}),e.jsx("li",{children:"(a && b) && (c > d) → com l'expressió de la dreta és false, aleshores (true && false) → false."})]})]}),e.jsxs(T,{title:"OR (||)",variant:"yellow",children:[e.jsxs("p",{children:["Al contrari que el AND, retorna TRUE si ",e.jsx("strong",{children:"AL MENYS UNA"})," expressió té valor TRUE"]}),e.jsxs("ul",{style:{marginTop:"10px",paddingLeft:"20px",listStyle:"none"},children:[e.jsx("li",{children:"(a || b) → com almenys una és true, el resultat és true."}),e.jsx("li",{children:"(a || false) → com a és true, el resultat és true."}),e.jsx("li",{children:"(false || false) → com cap és true, el resultat és false."}),e.jsx("li",{children:"(c == d || c > d) → (true || false) → true."})]})]}),e.jsx(T,{title:"NOT (!)",variant:"pink",children:e.jsx("p",{children:"Inverteix el valor d'una expressió booleana."})})]})]})}function PS(){return e.jsxs("div",{children:[e.jsx(S,{title:"Sintaxi de Java"}),e.jsx(m,{variant:"info",children:e.jsx("p",{children:"La sintaxi de Java és estructurada i orientada a objectes, heretada en gran part de C++. A continuació estan les estructures fonamentals del llenguatge: condicionals i bucles i, juntament amb la seva respectiva sintaxi per escriure codi clar i organitzat."})}),e.jsx(J,{headers:["Nom","Paraula reservada","Sintaxi"],rows:[{cells:["Variable","tipus","tipus variable = valor"]},{cells:["Constant","final","final tipus constant = valor"]},{cells:["Condicional if","if","if (condició) { }"]},{cells:["Condicional else if","else if","else if (altra_condició) { }"]},{cells:["Condicional else","else","else { }"]},{cells:["Bucle for","for","for (inicialització; condició; increment) { }"]},{cells:["Bucle for each","for","for (element : col·lecció) { }"]},{cells:["Bucle while","while","while (condició) { }"]},{cells:["Bucle do while","do while","do { } while (condició)"]},{cells:["Switch","switch","switch (variable) { case valor: }"]},{cells:["Mètode principal","main","public static void main (String[] args) { }"]},{cells:["Sentència break","break","break"]},{cells:["Sentència continue","continue","continue"]},{cells:["Retorn","return","return valor"]}]}),e.jsx(m,{variant:"explanation",title:"Extra",children:e.jsx("p",{children:"Un programa no és més que una seqüència d'instruccions que s'executen en ordre de dalt cap avall, llevat que utilitzem estructures que canvien aquest flux."})})]})}function NS(){return e.jsxs("div",{children:[e.jsx(S,{title:'Estructures condicionals → "fer preguntes"'}),e.jsx(m,{variant:"info",children:e.jsx("p",{children:"Utilitzem una estructura condicional quan el programa ha de prendre decisions."})}),e.jsxs(T,{title:"Exemple vida real",variant:"blue",children:[e.jsx("p",{children:"Si plou,"}),e.jsx("p",{children:"porto paraigua."}),e.jsx("p",{children:"Si no,"}),e.jsx("p",{children:"no me'l porto."})]}),e.jsxs(T,{title:"Esquema mental",variant:"yellow",children:[e.jsx("p",{children:"SI (condició és verdadera) → faig alguna cosa"}),e.jsx("p",{children:"SI NO → faig una altra cosa"})]}),e.jsx(g,{label:"En codi",code:`if (plou) {
    ...
    noPortoParagua();
}`})]})}function kS(){return e.jsxs("div",{children:[e.jsx(S,{title:`Switch → "menú d'opcions"`}),e.jsx(m,{variant:"info",children:e.jsx("p",{children:"Utilitzem switch quan tenim diverses opcions possibles i només una pot ser la correcta."})}),e.jsxs(T,{title:"Exemple vida real",variant:"blue",children:[e.jsx("p",{children:"Entro a un restaurant i trio:"}),e.jsx("p",{children:"1 → Pizza"}),e.jsx("p",{children:"2 → Amanida"}),e.jsx("p",{children:"3 → Pasta"})]}),e.jsx(T,{title:"Esquema mental",variant:"yellow",children:e.jsx("p",{children:"SEGONS l'opció que triïs → executo una cosa o una altra"})}),e.jsx(g,{label:"En codi",code:`switch (opcio) {
    case 1:
        demanarPizza();
        break;
    case 2:
...
aulaJava.impartirClasse();`}),e.jsx(S,{title:"Els 4 Pilars de la POO"}),e.jsx(m,{variant:"explanation",children:e.jsxs("p",{children:["La POO es fonamenta en ",e.jsx("strong",{children:"4 pilars"})," fonamentals que fan que el codi sigui organitzat, segur, reutilitzable i flexible."]})}),e.jsxs(me,{children:[e.jsxs(T,{title:"Encapsulació",variant:"blue",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Amagar les dades internes"})," d'un objecte i controlar-ne l'accés mitjançant mètodes públics (getters i setters)."]}),e.jsx("p",{style:{marginTop:"8px"},children:"Com una càpsula de medicament: no veus el contingut, però funciona."}),e.jsx(g,{code:`private String nom;
...
}`}),e.jsx(m,{variant:"success",children:e.jsx("p",{children:"Les dades estan protegides i validades."})})]})]}),e.jsx(S,{title:"Getters i Setters"}),e.jsx(m,{variant:"info",children:e.jsxs("p",{children:["Els ",e.jsx("strong",{children:"getters"})," són mètodes que retornen el valor d'un atribut privat. Els ",e.jsx("strong",{children:"setters"})," són mètodes que permeten modificar el valor d'un atribut privat, habitualment amb validació."]})}),e.jsx(g,{label:"Exemple complet amb getters i setters",showLineNumbers:!0,code:`public class Alumne {
...
}`}),e.jsx(m,{variant:"explanation",children:e.jsxs("p",{children:["Fixa't que el constructor ",e.jsx("strong",{children:"no té"})," ",e.jsx("code",{children:"void"})," ni cap altre tipus de retorn. Si hi poses ",e.jsx("code",{children:"void"}),", Java ho tractarà com un mètode normal, no com un constructor!"]})}),e.jsx(S,{title:"La Paraula Clau this"}),e.jsx(m,{variant:"info",children:e.jsxs("p",{children:["La paraula clau ",e.jsx("code",{children:"this"})," fa referència a l'",e.jsx("strong",{children:"objecte actual"}),". S'utilitza principalment quan el nom del paràmetre del constructor (o mètode) coincideix amb el nom de l'atribut de la classe."]})}),e.jsxs(oe,{children:[e.jsxs(U,{title:"Sense this (problema)",variant:"bad",children:[e.jsx(g,{code:`public Cotxe(String marca) {
    marca = marca; // ERROR!
...
}`}),e.jsx(m,{variant:"success",children:e.jsxs("p",{children:[e.jsx("code",{children:"this.marca"})," es refereix a l'atribut de l'objecte. ",e.jsx("code",{children:"marca"})," és el paràmetre."]})})]})]}),e.jsx(S,{title:"Exemple Complet"}),e.jsx(g,{label:"Classe Cotxe amb constructor",showLineNumbers:!0,code:`public class Cotxe {
...
}`,HE=`public class Gos extends Animal {
    public Gos(String nom) {
        super(nom);
    }
...
public class Main {
  ...
  app/
    Main.java         (20 línies)`})})]}),e.jsx(m,{variant:"info",title:"Recorda",children:e.jsxs("p",{children:["El primer pas per millorar el teu codi és ",e.jsx("strong",{children:"identificar les responsabilitats"})," del teu programa i crear una classe per a cadascuna. A la següent pàgina veurem com fer-ho pas a pas amb un exemple concret."]})})]})}function nC(){return e.jsxs("div",{children:[e.jsx(S,{title:"Packages: Organització del Codi"}),e.jsx(m,{variant:"info",title:"Què és un package?",children:e.jsxs("p",{children:["Un ",e.jsx("strong",{children:"package"})," és una carpeta que agrupa classes relacionades. És la manera que té Java d'organitzar el codi en projectes grans. Cada fitxer ",e.jsx("code",{children:".java"})," declara a quin package pertany, i per utilitzar classes d'un altre package cal importar-les."]})}),e.jsx(S,{title:"Estructura de Carpetes"}),e.jsx(m,{variant:"explanation",children:e.jsxs("p",{children:["L'estructura de carpetes del projecte ha de coincidir amb la declaració dels packages. Cada package és una carpeta, i cada classe és un fitxer",e.jsx("code",{children:".java"})," dins d'aquesta carpeta."]})}),e.jsx(g,{label:"Estructura de carpetes d'un projecte",language:"bash",code:`el-meu-projecte/
  src/
    utils/                          ← Package "utils"
...
}`})})]}),e.jsx(S,{title:"Resum"}),e.jsx(J,{headers:["Característica","for tradicional","for-each"],rows:[{cells:["Accés a l'índex","Sí","No"]},{cells:["Modificar l'array","Sí","No (modifica còpia)"]},{cells:["Recórrer parcialment","Sí","No (sempre recorre tot)"]},{cells:["Recórrer al revés","Sí","No"]},{cells:["Llegibilitat","Correcta","Més neta i curta"]},{cells:["Funciona amb ArrayList","Sí (.get/.size)","Sí (directament)"]}]}),e.jsx(m,{variant:"success",title:"Consell",children:e.jsxs("p",{children:["Domina primer el ",e.jsx("strong",{children:"for tradicional"}),", que és el que trobaràs a la majoria d'exercicis i exàmens. Un cop el tinguis clar, el for-each et serà molt fàcil d'incorporar com a eina complementària."]})})]})}function $C(){return e.jsxs("div",{children:[e.jsx(S,{title:"Operador Ternari: if-else compacte en una línia"}),e.jsxs(m,{variant:"info",children:[e.jsxs("p",{children:["L'operador ternari és una forma ",e.jsx("strong",{children:"compacta"})," d'escriure un if-else senzill en una sola línia. És útil quan vols assignar un valor a una variable en funció d'una condició simple."]}),e.jsxs("p",{style:{marginTop:"8px"},children:["Recorda: el ",e.jsx("strong",{children:"if-else tradicional"})," segueix sent la forma estàndard i prioritària. L'operador ternari és un complement per a casos concrets."]})]}),e.jsx(S,{title:"Sintaxi"}),e.jsx(g,{label:"Estructura de l'operador ternari",code:"variable = condicio ? valorSiTrue : valorSiFalse;"}),e.jsx(m,{variant:"explanation",children:e.jsxs("p",{children:["Es llegeix com: ",e.jsx("strong",{children:'"Si la condició és certa, agafa el primer valor; si no, agafa el segon."'})]})}),e.jsxs(T,{title:"Esquema mental",variant:"blue",children:[e.jsx("p",{children:"CONDICIÓ → si TRUE → valor A"}),e.jsx("p",{children:"CONDICIÓ → si FALSE → valor B"})]}),e.jsx(S,{title:"Comparació: if-else vs ternari"}),e.jsxs(oe,{children:[e.jsx(U,{title:"If-else tradicional (5+ línies)",variant:"blue",children:e.jsx(g,{code:`String resultat;
...
System.out.println("Valor absolut: " + absolut); // 42`}),e.jsx(S,{title:"Ternari aniuat (existeix, però no el recomanem)"}),e.jsx(m,{variant:"warning",title:"Evita els ternaris aniuats",children:e.jsxs("p",{children:["Tècnicament és possible encadenar ternaris, però el resultat és un codi molt difícil de llegir i mantenir. ",e.jsx("strong",{children:"No ho recomanem."})]})}),e.jsxs(oe,{children:[e.jsx(U,{title:"Ternari aniuat (difícil de llegir)",variant:"bad",children:e.jsx(g,{code:`// NO recomanat!
...
var config = inicialitzar();`})]})]}),e.jsx(S,{title:"Text blocks: strings multilínia (Java 13+)"}),e.jsx(m,{variant:"info",children:e.jsxs("p",{children:["Els ",e.jsx("strong",{children:"text blocks"})," permeten escriure cadenes de text de múltiples línies sense haver de concatenar ni usar ",e.jsx("code",{children:"\\n"}),". S'utilitzen tres cometes dobles ",e.jsx("code",{children:'"""'})," per obrir i tancar."]})}),e.jsxs(oe,{children:[e.jsx(U,{title:"Forma tradicional",variant:"blue",children:e.jsx(g,{code:`String json = "{\\n" +
    "  \\"nom\\": \\"Anna\\",\\n" +
    "  \\"edat\\": 25\\n" +
...
String menu = """
    ...
    3. Sortir
    ===================""";
System.out.println(menu);`}),e.jsx(S,{title:"Switch expressions: switch que retorna valor (Java 14+)"}),e.jsx(m,{variant:"info",children:e.jsxs("p",{children:["Les ",e.jsx("strong",{children:"switch expressions"})," són una versió millorada del switch que pot retornar un valor directament, utilitza fletxes (",e.jsx("code",{children:"->"}),") en comptes de ",e.jsx("code",{children:"case/break"}),", i és més compacte."]})}),e.jsxs(oe,{children:[e.jsx(U,{title:"Switch tradicional",variant:"blue",children:e.jsx(g,{code:`String nomDia;
switch (dia) {
    case 1:
        nomDia = "Dilluns";
        break;
...
# Si no entens per que, pots preguntar-li directament o mirar el commit e8c3d6f.`}),e.jsx(S,{title:"Manteniment: el codi creix i s'ha de cuidar"}),e.jsx(m,{variant:"explanation",title:"El codi es com un jardi",children:e.jsxs("p",{children:["Si ningu el cuida, creix descontrolat. Les males herbes (codi duplicat, funcions massa llargues, noms confusos) s'acumulen poc a poc fins que el projecte es inmantenible. Per aixo existeix el ",e.jsx("strong",{children:"refactoring"}),": canviar l'estructura del codi ",e.jsx("strong",{children:"sense canviar el que fa"})," per mantenir-lo net."]})}),e.jsxs(oe,{children:[e.jsx(U,{title:"Codi que necessita refactoring",variant:"bad",children:e.jsx(g,{code:`// Metode de 80 linies que fa 5 coses
...
// accessible al navegador a: http://localhost:8080/images/gos.jpg`,gw=`<!-- AQUESTA es la linia que afegirem a cada HTML que creem.
...
<!-- Que es? Un <link> que carrega el CSS de Bootstrap des d'internet.
     ...
     CSS de Bootstrap ja estan disponibles a la pagina. -->`,jw=`<!-- ASI quedara el <head> de joc.html (al Pas 6): -->
...
</html>`,vw=`// src/main/java/com/exemple/endevinaanimal/controller/JocController.java
...
}`,bw=`<!-- src/main/resources/templates/joc.html -->
...
</html>`,yw=`<!-- src/main/resources/templates/encertat.html -->
...
└── pom.xml`,Ew=`// Que passa quan l'usuari escriu "Gos" i clica "Endevinar"?
...
// CONTROLLER -> JocController.java (coordina)`,Cw=`// REPTE per al proxim dia (no cal fer-ho ara)
//
...
}`}),e.jsx(J,{headers:["Tipus de test","Que prova","Exemple"],rows:[{cells:["Unitari","Una sola classe o metode, aillat","TaulaTest: comprova que potAcollir() funciona correctament"]},{cells:["Integracio","Multiples classes juntes","ServeiReservesTest: comprova que ferReserva() crea una reserva i ocupa la taula"]},{cells:["End-to-End","Tot el sistema, de frontend a BD","Simula un usuari fent una reserva des de l'app"]}]}),e.jsx(S,{title:"4. CI/CD: automatitzar tot el proces"}),e.jsxs(m,{variant:"explanation",title:"Que es CI/CD?",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"CI"})," (Continuous Integration): cada cop que algu fa push, automaticament s'executen els tests. Si falla algun, tothom ho sap immediatament."]}),e.jsxs("p",{style:{marginTop:"8px"},children:[e.jsx("strong",{children:"CD"})," (Continuous Deployment): si tots els tests passen, l'aplicacio es desplega automaticament al servidor."]})]}),e.jsx(qe,{src:"projecte-cicd",title:"Pipeline CI/CD"}),e.jsx(g,{label:".github/workflows/ci.yml (GitHub Actions)",showLineNumbers:!0,code:`name: CI Pipeline
